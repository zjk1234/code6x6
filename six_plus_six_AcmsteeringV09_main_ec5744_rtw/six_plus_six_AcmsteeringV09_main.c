 ...
 *
 * FILE    : six_plus_six_AcmsteeringV09_main.c
 *
 * VERSION : 1.2701
 *
...
real_T guzhang_lf = 0.0;               /* Variable: guzhang_lf
                                        * Referenced by:
                                        *   '<S568>/ECCalVar'
                                        *   '<S1023>/ECCalVar'
                                        */
real_T guzhang_lm = 0.0;               /* Variable: guzhang_lm
                                        * Referenced by:
                                        *   '<S568>/ECCalVar1'
                                        *   '<S1023>/ECCalVar1'
                                        */
...
real32_T ESP_switch = 0.0F;            /* Variable: ESP_switch
                                        ...
                                        *   '<S1028>/Constant3'
                                        */
real32_T RC_switch = 1.0F;             /* Variable: RC_switch
                                        * Referenced by:
                                        *   '<S568>/Constant11'
                                        *   '<S1023>/Constant11'
                                        */
...
{
  /* Call the system: <S1200>/CCPReceive */
  {
    /* Output and update for function-call system: '<S1200>/CCPReceive' */

    /* S-Function (ec5744_canreceiveslb): '<S1216>/CANReceive' */
    ...
    /* Nothing to do for system: <S1216>/Nothing */
  }
 ...
 */
void six_plus_six_AcmsteeringV09_main_SetEventsForThisBaseStep(boolean_T
  *eventFlags)
{
  ...
  B_MATLABFunction_six_plus_six_T *localB)
{
  ...
  /* MATLAB Function 'Subsystem/MATLAB Function': '<S1218>:1' */
  if (rtu_data_1 < 150.0) {
    /* '<S1218>:1:2' */
...
{
  /* MATLAB Function 'MainControl/mode_control/Park/park/HeartBeat': '<S416>:1' */
  /* '<S416>:1:3' */
...
{
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/MATLAB Function': '<S1016>:1' */
  ...
  rtu_bra_pre_gz2, B_MATLABFunction_six_plus_s_p_T *localB)
{
  ...
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/容错控制/MATLAB Function': '<S1151>:1' */
...
/*
 * Output and update for atomic system:
 *    '<S1023>/MATLAB Function5'
 *    '<S568>/MATLAB Function5'
 */
void six_plus_si_MATLABFunction5(real32_T rtu_RC_switch, real_T rtu_guzhang_lf,
  real_T rtu_guzhang_lm, real_T rtu_guzhang_lr, real_T rtu_guzhang_rf, real_T
  rtu_guzhang_rm, real_T rtu_guzhang_rr, B_MATLABFunction5_six_plus_si_T *localB)
{
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/容错控制/MATLAB Function5': '<S1152>:1' */
  if (rtu_RC_switch == 0.0F) {
    /* '<S1152>:1:3' */
    /* '<S1152>:1:4' */
    ...
    /* '<S1152>:1:11' */
    localB->guzhang_lf1 = (real32_T)rtu_guzhang_lf;

    /* '<S1152>:1:12' */
    localB->guzhang_lm1 = (real32_T)rtu_guzhang_lm;
  ...
  B_MATLABFunction_six_plus_s_i_T *localB)
{
  ...
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/左右侧电机分配及功率限制/MATLAB Function': '<S1153>:1' */
  ...
  real32_T rtu_speed_act_rm, real32_T rtu_speed_act_rr)
{
  ...
  look1_iflf_binlx(rtu_speed_act_lf, six_plus_six_Acmsteering_ConstP.pooled75,
                   six_plus_six_Acmsteering_ConstP.pooled74, 11U);

  /* Lookup_n-D: '<S1026>/mot_map2' */
  look1_iflf_binlx(rtu_speed_act_lm, six_plus_six_Acmsteering_ConstP.pooled75,
                   six_plus_six_Acmsteering_ConstP.pooled74, 11U);

  /* Lookup_n-D: '<S1026>/mot_map1' */
  look1_iflf_binlx(rtu_speed_act_lr, six_plus_six_Acmsteering_ConstP.pooled75,
                   six_plus_six_Acmsteering_ConstP.pooled74, 11U);

  /* Lookup_n-D: '<S1026>/mot_map3' */
  look1_iflf_binlx(rtu_speed_act_rf, six_plus_six_Acmsteering_ConstP.pooled75,
                   six_plus_six_Acmsteering_ConstP.pooled74, 11U);

  /* Lookup_n-D: '<S1026>/mot_map4' */
  look1_iflf_binlx(rtu_speed_act_rm, six_plus_six_Acmsteering_ConstP.pooled75,
                   six_plus_six_Acmsteering_ConstP.pooled74, 11U);

  /* Lookup_n-D: '<S1026>/mot_map5' */
  look1_iflf_binlx(rtu_speed_act_rr, six_plus_six_Acmsteering_ConstP.pooled75,
                   six_plus_six_Acmsteering_ConstP.pooled74, 11U);

  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/目标转向力矩确定模块/MATLAB Function': '<S1154>:1' */
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/目标转向力矩确定模块/MATLAB Function1': '<S1155>:1' */
  /* '<S1155>:1:4' */
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/目标转向力矩确定模块/MATLAB Function2': '<S1156>:1' */
  /* '<S1156>:1:4' */
  /* '<S1156>:1:5' */
}
...
/*
 * Output and update for atomic system:
 *    '<S1167>/MATLAB Function'
 *    '<S712>/MATLAB Function'
 */
...
{
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function': '<S1174>:1' */
...
/*
 * Output and update for atomic system:
 *    '<S1167>/MATLAB Function1'
 *    '<S712>/MATLAB Function1'
 */
...
{
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function1': '<S1175>:1' */
...
/*
 * Output and update for atomic system:
 *    '<S1167>/MATLAB Function2'
 *    '<S712>/MATLAB Function2'
 */
...
{
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function2': '<S1176>:1' */
...
/*
 * Output and update for atomic system:
 *    '<S1167>/MATLAB Function3'
 *    '<S712>/MATLAB Function3'
 */
...
{
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function3': '<S1177>:1' */
...
/*
 * Output and update for atomic system:
 *    '<S1167>/MATLAB Function4'
 *    '<S712>/MATLAB Function4'
 */
...
{
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function4': '<S1178>:1' */
...
/*
 * Output and update for atomic system:
 *    '<S1167>/MATLAB Function6'
 *    '<S712>/MATLAB Function6'
 */
...
{
  /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function6': '<S1180>:1' */
...
void six_plus_six_AcmsteeringV09_main_step0(void) /* Sample time: [0.0005s, 0.0s] */
{
...
void six_plus_six_AcmsteeringV09_main_step1(void) /* Sample time: [0.001s, 0.0s] */
{
  /* S-Function (fcncallgen): '<S1200>/Function-Call Generator' incorporates:
   *  SubSystem: '<S1200>/CCPBackground'
   */

  /* S-Function (ec5744_ccpslb): '<S1215>/CCPBackground' */
  ccpBackground();
}

/* Model step function for TID2 */
void six_plus_six_AcmsteeringV09_main_step2(void) /* Sample time: [0.005s, 0.0s] */
{
  /* S-Function (fcncallgen): '<S1198>/5ms' incorporates:
   *  SubSystem: '<S1198>/daq5ms'
   */
...
void six_plus_six_AcmsteeringV09_main_step3(void) /* Sample time: [0.01s, 0.0s] */
{
  /* S-Function (fcncallgen): '<S1198>/10ms' incorporates:
   *  SubSystem: '<S1198>/daq10ms'
   */
...
void six_plus_six_AcmsteeringV09_main_step4(void) /* Sample time: [0.05s, 0.0s] */
{
  ...
  real_T rtb_Add;
  boolean_T rtb_Compare_n5;
  boolean_T rtb_Compare_b2y;
  boolean_T rtb_Compare_atf;
  boolean_T rtb_Compare_l3;
  boolean_T rtb_Compare_ix;
  ...
  boolean_T rtb_Compare_kx;
  boolean_T rtb_Compare_gq;
  boolean_T rtb_Compare_iu;
  real_T rtb_Memory4_e;
  real_T rtb_Subtract1_j;
  real32_T rtb_Add2_c;
  real_T rtb_Sum_i;
  real32_T rtb_Abs1_f;
  real32_T rtb_Abs10_n;
  real32_T rtb_mot_map_a;
  real32_T rtb_mot_map1_j;
  real32_T rtb_mot_map4_k;
  real32_T rtb_mot_map5_p;
  ...
  real32_T rtb_Abs8_m;
  real32_T rtb_Abs9_p;
  real32_T rtb_DLookupTable_g;
  real32_T rtb_DLookupTable6_p;
  real32_T rtb_DLookupTable7_e;
  real32_T rtb_DLookupTable3_e;
  boolean_T Compare;
  boolean_T Compare_g;
  boolean_T Compare_p;
  boolean_T Compare_i;
   ...
   */
  Compare_g = (six_plus_six_AcmsteeringV09_m_B.Signals[271] == 8.0);
   ...
   */
  Compare_i = (six_plus_six_AcmsteeringV09_m_B.Signals[270] == 8.0);

  /* MATLAB Function: '<S2>/MATLAB Function1' */
  /* MATLAB Function 'InputSignalProcess/MATLAB Function1': '<S406>:1' */
  /* '<S406>:1:3' */
  /* '<S406>:1:4' */
  /* '<S406>:1:5' */
  /* '<S406>:1:6' */
  ...
  /* MATLAB Function 'InputSignalProcess/MATLAB Function': '<S405>:1' */
  ...
  if (rtb_y < 0.0) {
    rtb_Abs1 = (real32_T)-rtb_y;
  } else {
    rtb_Abs1 = (real32_T)rtb_y;
  }

  /* End of Abs: '<S408>/Abs1' */
  ...
  /* End of Abs: '<S408>/Abs2' */

  /* Abs: '<S408>/Abs3' */
  rtb_y = six_plus_six_AcmsteeringV09_m_B.Signals[130];
  if (rtb_y < 0.0) {
    rtb_Abs3 = (real32_T)-rtb_y;
  } else {
    rtb_Abs3 = (real32_T)rtb_y;
  }

  /* End of Abs: '<S408>/Abs3' */
  ...
  /* End of Abs: '<S408>/Abs5' */

  /* Memory: '<S408>/Memory' */
  rtb_Memory_cn = six_plus_six_AcmsteeringV09__DW.Memory_PreviousInput_o;

  /* MATLAB Function: '<S408>/mode_switch' incorporates:
   *  Constant: '<S408>/Constant2'
   */
  /* MATLAB Function 'MainControl/mode_switch/mode_switch': '<S1196>:1' */
  /* '<S1196>:1:3' */
  mode_dem_out = rtb_Memory_cn;
  if ((Compare == 1) && (rtb_Abs <= 464.14389F) && (rtb_Abs1 <= 464.14389F) &&
      (rtb_acc_dem <= 464.14389F) && (rtb_Abs3 <= 464.14389F) && (rtb_steer_dem <=
       464.14389F) && (rtb_brake_dem <= 464.14389F) && (rtb_Compare == 0)) {
    /* '<S1196>:1:5' */
    /* '<S1196>:1:6' */
    mode_dem_out = 0;
  } else if ((acc_dem > 0.0F) && (rtb_Abs >= 0.0F) && (rtb_Abs1 >= 0.0F) &&
             (rtb_acc_dem >= 0.0F) && (rtb_Abs3 >= 0.0F) && (rtb_steer_dem >=
              0.0F) && (rtb_brake_dem >= 0.0F) && (rtb_Compare == 0) && (Compare
              == 0) && (Compare_g == 0)) {
    /* '<S1196>:1:7' */
    /* '<S1196>:1:8' */
    mode_dem_out = 1;
    ...
    /* '<S1196>:1:12' */
    mode_dem_out = 3;
  } else if ((Compare_g == 1) && (rtb_Compare == 0) && (Compare == 0)) {
    /* '<S1196>:1:13' */
    /* '<S1196>:1:14' */
    mode_dem_out = 4;
  } else {
  ...
  /* End of MATLAB Function: '<S408>/mode_switch' */

  /* SwitchCase: '<S407>/Switch Case' */
  ...
  switch (rtAction) {
   case 0:
    ...
    /* MATLAB Function: '<S415>/HeartBeat3' */
    ...
    /* MATLAB Function: '<S415>/HeartBeat1' */
    ...
    /* MATLAB Function: '<S415>/HeartBeat2' */
    ...
    /* MATLAB Function: '<S415>/HeartBeat4' */
    ...
    /* Gain: '<S415>/Gain' */
    rtb_steer_dem = 0.5F * rtb_Gain5_d;
    ...
    /* Gain: '<S415>/Gain1' */
    rtb_Gain5_d = -rtb_Gain5_d;

    /* Saturate: '<S415>/Saturation2' */
    if (rtb_Gain5_d > 400000.0F) {
      rtb_Gain5_d = 400000.0F;
    } else {
      if (rtb_Gain5_d < -400000.0F) {
        rtb_Gain5_d = -400000.0F;
      }
    ...
    /* End of Saturate: '<S415>/Saturation2' */

    /* Lookup_n-D: '<S415>/1-D Lookup Table2' */
    ...
    /* End of Saturate: '<S415>/Saturation3' */

    /* SignalConversion: '<S409>/OutportBufferForpark_dem' incorporates:
     *  Constant: '<S415>/SpdSet_dem'
     *  Constant: '<S415>/SpdSet_dem1'
     *  Constant: '<S415>/SpdSet_dem2'
     *  Constant: '<S415>/SpdSet_dem3'
     *  Constant: '<S415>/SpdSet_dem4'
     *  Constant: '<S415>/SpdSet_dem5'
     *  Constant: '<S415>/TrqSet_dem'
     *  Constant: '<S415>/TrqSet_dem1'
     *  Constant: '<S415>/TrqSet_dem2'
     *  Constant: '<S415>/TrqSet_dem3'
     *  Constant: '<S415>/TrqSet_dem4'
     *  Constant: '<S415>/TrqSet_dem5'
     *  Constant: '<S415>/mot_enable'
     *  Constant: '<S415>/mot_enable1'
     *  Constant: '<S415>/mot_enable2'
     *  Constant: '<S415>/mot_enable3'
     *  Constant: '<S415>/mot_enable4'
     *  Constant: '<S415>/mot_enable5'
     *  Constant: '<S415>/mot_gear'
     *  Constant: '<S415>/mot_gear1'
     *  Constant: '<S415>/mot_gear2'
     *  Constant: '<S415>/mot_gear3'
     *  Constant: '<S415>/mot_gear4'
     *  Constant: '<S415>/mot_gear5'
     *  Constant: '<S415>/mot_mode'
     *  Constant: '<S415>/mot_mode1'
     *  Constant: '<S415>/mot_mode2'
     *  Constant: '<S415>/mot_mode3'
     *  Constant: '<S415>/mot_mode4'
     *  Constant: '<S415>/mot_mode5'
     */
    ...
    six_plus_six_AcmsteeringV09_m_B.OutportBufferForpark_dem[38] = rtb_Gain5_d;
    ...
    /* Update for Memory: '<S415>/Memory4' */
    six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_mk =
      six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat3.life;

    /* Update for Memory: '<S415>/Memory1' */
    six_plus_six_AcmsteeringV09__DW.Memory1_PreviousInput_d =
      six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat1.life;

    /* Update for Memory: '<S415>/Memory2' */
    six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_m4 =
      six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat2.life;

    /* Update for Memory: '<S415>/Memory6' */
    six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_c =
      six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat4.life;

    /* Update for Memory: '<S415>/Memory3' */
    six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_gx =
      six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat5.life;

    /* End of Outputs for SubSystem: '<S407>/Park' */
    break;

   case 1:
    /* Outputs for IfAction SubSystem: '<S407>/forward' incorporates:
     *  ActionPort: '<S413>/Action Port'
     */
    /* MATLAB Function: '<S877>/MATLAB Function' */
    /* MATLAB Function 'MainControl/mode_control/forward/forward/MATLAB Function': '<S880>:1' */
    if (brake_dem == 0.0F) {
      /* '<S880>:1:10' */
      /* '<S880>:1:11' */
      rtb_y_o = 0;
    ...
    /* End of MATLAB Function: '<S877>/MATLAB Function' */

    /* SwitchCase: '<S877>/Switch Case1' incorporates:
     *  Constant: '<S1027>/Constant'
     *  Constant: '<S1027>/Constant1'
     */
    rtb_Memory_cn =
    ...
    switch (rtAction) {
     case 0:
      /* Outputs for IfAction SubSystem: '<S877>/Drive' incorporates:
       *  ActionPort: '<S879>/Action Port'
       */
      /* Abs: '<S879>/Abs' */
      rtb_y = six_plus_six_AcmsteeringV09_m_B.Signals[235];
      if (rtb_y < 0.0) {
        rtb_Gain_p = (real32_T)-rtb_y;
      } else {
        rtb_Gain_p = (real32_T)rtb_y;
      }
      ...
      /* End of Abs: '<S879>/Abs24' */

      /* Abs: '<S879>/Abs3' */
      rtb_y = six_plus_six_AcmsteeringV09_m_B.Signals[60];
      if (rtb_y < 0.0) {
        rtb_DLookupTable_g = (real32_T)-rtb_y;
      } else {
        rtb_DLookupTable_g = (real32_T)rtb_y;
      }
      ...
      switch (six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_a.y) {
       case 0:
        ...
        /* Gain: '<S1028>/Gain6' */
        rtb_Gain5_d = (real32_T)(ki1 * rtb_Sum_i);

        /* Gain: '<S1028>/Gain7' */
        rtb_Saturation3_m = (real32_T)(kd1 * rtb_y);

        /* Sum: '<S1028>/Add2' */
        rtb_Add2_c = (rtb_Add2_c + rtb_Gain5_d) + rtb_Saturation3_m;

        /* Memory: '<S1028>/Memory13' */
        rtb_Saturation3_m =
          six_plus_six_AcmsteeringV09__DW.Memory13_PreviousInput_h;

        /* Sum: '<S1028>/Subtract5' */
        rtb_Gain5_d = rtb_Add2_c + rtb_Saturation3_m;

        /* Switch: '<S1028>/Switch1' incorporates:
         *  Constant: '<S1028>/Constant3'
         *  Constant: '<S1028>/Constant4'
         */
        if (ESP_switch > 0.5F) {
          /* Switch: '<S1028>/Switch' incorporates:
           *  Constant: '<S1028>/Constant1'
           *  Constant: '<S1028>/Constant2'
           */
          if (acc_y >= 0.0) {
            rtb_Memory_cn = 1;
          } else {
          ...
          /* Product: '<S1028>/Product' */
          rtb_steer_dem = rtb_Gain5_d * (real32_T)rtb_Memory_cn;

          /* Gain: '<S1028>/Gain3' */
          rtb_steer_dem *= 0.125F;
          delta_Twending_dem = rtb_steer_dem;
        } else {
        ...
        /* Update for Memory: '<S1028>/Memory4' */
        six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_b = rtb_Sum_i;

        /* Update for Memory: '<S1028>/Memory5' */
        six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_i = rtb_Memory4_e;

        /* Update for Memory: '<S1028>/Memory3' */
        six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_l = rtb_Sum_i;

        /* Update for Memory: '<S1028>/Memory13' */
        six_plus_six_AcmsteeringV09__DW.Memory13_PreviousInput_h = rtb_Gain5_d;

        /* End of Outputs for SubSystem: '<S879>/车辆稳定性控制' */
        break;

       case 1:
        /* Outputs for IfAction SubSystem: '<S879>/车辆稳定性控制1' incorporates:
         *  ActionPort: '<S1029>/Action Port'
         */
        six_plus_six_AcmsteeringV09_m_B.Constant4_p = 0.0F;

        /* End of Outputs for SubSystem: '<S879>/车辆稳定性控制1' */
        break;
      }

      /* End of SwitchCase: '<S879>/Switch Case' */

      /* MultiPortSwitch: '<S879>/Multiport Switch' */
      ...
      /* End of MultiPortSwitch: '<S879>/Multiport Switch' */

      /* Lookup_n-D: '<S1024>/mot_map' */
      rtb_Gain5_d = look1_iflf_binlx(rtb_Gain_p,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* MinMax: '<S1024>/MinMax6' */
      u0 = rtb_Gain5_d;
      ...
      /* End of MinMax: '<S1024>/MinMax6' */

      /* Lookup_n-D: '<S1024>/mot_map4' */
      rtb_Gain5_d = look1_iflf_binlx(rtb_Abs1_f,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* MinMax: '<S1024>/MinMax7' */
      u0 = rtb_Gain5_d;
      ...
      /* End of MinMax: '<S1024>/MinMax7' */

      /* Lookup_n-D: '<S1024>/mot_map1' */
      rtb_Gain5_d = look1_iflf_binlx(rtb_Abs10_n,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* MinMax: '<S1024>/MinMax5' */
      u0 = rtb_Gain5_d;
      ...
      /* Sum: '<S1024>/Add1' */
      rtb_Gain_p = ((((rtb_Gain_p + rtb_Abs1_f) + rtb_Abs10_n) + rtb_brake_dem)
                    + rtb_Abs) + rtb_DLookupTable_g;

      /* Gain: '<S1024>/Gain' */
      rtb_Gain_p *= 0.166666672F;

      /* Product: '<S1024>/Divide' */
      rtb_Gain1_j = 9549.0 * rtb_y / rtb_Gain_p;

      /* Gain: '<S1025>/Gain' */
      rtb_Gain5_d = 0.01F * acc_dem;

      /* Lookup_n-D: '<S1025>/mot_map' */
      rtb_mot_map_a = look1_iflf_binlx(rtb_mot_map_a,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      rtb_mot_map1_j = look1_iflf_binlx(rtb_mot_map1_j,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      rtb_mot_map4_k = look1_iflf_binlx(rtb_mot_map4_k,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      rtb_mot_map5_p = look1_iflf_binlx(rtb_mot_map5_p,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      rtb_acc_dem = look1_iflf_binlx(rtb_acc_dem,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      /* End of MinMax: '<S1024>/MinMax1' */

      /* Lookup_n-D: '<S1024>/mot_map2' */
      rtb_brake_dem = look1_iflf_binlx(rtb_brake_dem,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* MinMax: '<S1024>/MinMax4' */
      u0 = rtb_brake_dem;
      ...
      /* End of MinMax: '<S1024>/MinMax4' */

      /* Lookup_n-D: '<S1024>/mot_map5' */
      rtb_Abs = look1_iflf_binlx(rtb_Abs,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* MinMax: '<S1024>/MinMax8' */
      u0 = rtb_Abs;
      ...
      /* End of MinMax: '<S1024>/MinMax8' */

      /* Lookup_n-D: '<S1024>/mot_map3' */
      rtb_DLookupTable_g = look1_iflf_binlx(rtb_DLookupTable_g,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* MinMax: '<S1024>/MinMax3' */
      u0 = rtb_DLookupTable_g;
      ...
      /* End of MinMax: '<S1024>/MinMax2' */

      /* MATLAB Function: '<S1024>/MATLAB Function' */
      ...
      /* MATLAB Function: '<S1023>/MATLAB Function5' incorporates:
       *  Constant: '<S1023>/Constant11'
       *  Constant: '<S1023>/ECCalVar'
       *  Constant: '<S1023>/ECCalVar1'
       *  Constant: '<S1023>/ECCalVar2'
       *  Constant: '<S1023>/ECCalVar3'
       *  Constant: '<S1023>/ECCalVar4'
       *  Constant: '<S1023>/ECCalVar5'
       */
      six_plus_si_MATLABFunction5(RC_switch, guzhang_lf, guzhang_lm, guzhang_lr,
        guzhang_rf, guzhang_rm, guzhang_rr,
        &six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction5);

      /* DataTypeConversion: '<S1023>/Data Type Conversion' */
      rtb_guzhang_lf_m =
        six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction5.guzhang_lf1;

      /* DataTypeConversion: '<S1023>/Data Type Conversion1' */
      rtb_guzhang_lm_o =
        six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction5.guzhang_lm1;

      /* DataTypeConversion: '<S1023>/Data Type Conversion2' */
      rtb_guzhang_lr_g =
        six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction5.guzhang_lr1;

      /* DataTypeConversion: '<S1023>/Data Type Conversion3' */
      rtb_guzhang_rf_j =
        six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction5.guzhang_rf1;

      /* DataTypeConversion: '<S1023>/Data Type Conversion4' */
      rtb_guzhang_rm_i =
        six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction5.guzhang_rm1;

      /* DataTypeConversion: '<S1023>/Data Type Conversion5' */
      rtb_guzhang_rr_p =
        six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction5.guzhang_rr1;

      /* MATLAB Function: '<S1023>/MATLAB Function' incorporates:
      ...
      /* End of Abs: '<S1027>/Abs20' */

      /* MinMax: '<S1027>/MinMax' */
      if (!((rtb_Gain5_d <= rtb_DLookupTable_g) || rtIsNaNF(rtb_DLookupTable_g)))
      {
        rtb_Gain5_d = rtb_DLookupTable_g;
      }

      if (!((rtb_Gain5_d <= rtb_Abs) || rtIsNaNF(rtb_Abs))) {
        rtb_Gain5_d = rtb_Abs;
      }

      if (!((rtb_Gain5_d <= rtb_Abs14_m) || rtIsNaNF(rtb_Abs14_m))) {
        rtb_Gain5_d = rtb_Abs14_m;
      }

      if (!((rtb_Gain5_d <= rtb_brake_dem) || rtIsNaNF(rtb_brake_dem))) {
        rtb_Gain5_d = rtb_brake_dem;
      }

      if (!((rtb_Gain5_d <= rtb_acc_dem) || rtIsNaNF(rtb_acc_dem))) {
        rtb_Gain5_d = rtb_acc_dem;
      }

      /* End of MinMax: '<S1027>/MinMax' */
      ...
      /* Lookup_n-D: '<S1027>/1-D Lookup Table' */
      rtb_DLookupTable_h = look1_iflf_binlx(rtb_Gain5_d,
        six_plus_six_Acmsteering_ConstP.pooled69,
        six_plus_six_Acmsteering_ConstP.pooled68, 3U);

      /* Outputs for Atomic SubSystem: '<S1030>/直行TCS' */
      /* Gain: '<S1159>/Gain3' */
      rtb_Abs1_f = 0.125F * rtb_Abs1;

      /* Gain: '<S1159>/Gain' */
      rtb_Abs1_f *= 0.104719758F;

      /* Gain: '<S1159>/Gain1' */
      rtb_Abs1_f *= 0.2286F;

      /* MinMax: '<S1165>/MinMax' */
      if ((rtb_Abs1 <= rtb_Abs3) || rtIsNaNF(rtb_Abs3)) {
        rtb_Gain5_d = rtb_Abs1;
      } else {
        rtb_Gain5_d = rtb_Abs3;
      }

      if ((rtb_Gain5_d <= rtb_Abs6_i) || rtIsNaNF(rtb_Abs6_i)) {
        rtb_acc_dem = rtb_Gain5_d;
      } else {
        rtb_acc_dem = rtb_Abs6_i;
      }

      /* End of MinMax: '<S1165>/MinMax' */
      ...
      /* Sum: '<S1159>/Subtract' */
      rtb_steer_dem = rtb_Abs1_f - rtb_steer_dem;

      /* Sum: '<S1159>/Add' incorporates:
       *  Constant: '<S1159>/Constant'
       */
      rtb_Abs1_f += 2.22044605E-16F;

      /* Product: '<S1159>/Divide' */
      s_act_lf = rtb_steer_dem / rtb_Abs1_f;

      /* Saturate: '<S1158>/Saturation' */
      rtb_DLookupTable3_e = s_act_lf;
      if (rtb_DLookupTable3_e > 2.0F) {
        rtb_Saturation_a = 2.0F;
      } else if (rtb_DLookupTable3_e < 0.0F) {
        rtb_Saturation_a = 0.0F;
      } else {
        rtb_Saturation_a = rtb_DLookupTable3_e;
      }

      /* End of Saturate: '<S1158>/Saturation' */

      /* Gain: '<S1160>/Gain3' */
      rtb_steer_dem = 0.125F * rtb_Abs3;
      ...
      /* Gain: '<S1160>/Gain2' */
      rtb_Abs1_f = 0.277777791F * rtb_acc_dem;

      /* Sum: '<S1160>/Subtract' */
      rtb_Abs1_f = rtb_steer_dem - rtb_Abs1_f;
      ...
      s_act_lm = rtb_Abs1_f / rtb_steer_dem;

      /* Saturate: '<S1158>/Saturation1' */
      rtb_DLookupTable3_e = s_act_lm;
      if (rtb_DLookupTable3_e > 2.0F) {
        rtb_Saturation1_j = 2.0F;
      } else if (rtb_DLookupTable3_e < 0.0F) {
        rtb_Saturation1_j = 0.0F;
      } else {
        rtb_Saturation1_j = rtb_DLookupTable3_e;
      }

      /* End of Saturate: '<S1158>/Saturation1' */
      ...
      /* Saturate: '<S1158>/Saturation2' */
      rtb_DLookupTable3_e = s_act_lr;
      if (rtb_DLookupTable3_e > 2.0F) {
        rtb_Saturation2_p = 2.0F;
      } else if (rtb_DLookupTable3_e < 0.0F) {
        rtb_Saturation2_p = 0.0F;
      } else {
        rtb_Saturation2_p = rtb_DLookupTable3_e;
      }

      /* End of Saturate: '<S1158>/Saturation2' */
      ...
      if ((rtb_Abs7_j <= rtb_Abs8_m) || rtIsNaNF(rtb_Abs8_m)) {
        rtb_Gain5_d = rtb_Abs7_j;
      } else {
        rtb_Gain5_d = rtb_Abs8_m;
      }

      if ((rtb_Gain5_d <= rtb_Abs9_p) || rtIsNaNF(rtb_Abs9_p)) {
        rtb_acc_dem = rtb_Gain5_d;
      } else {
      ...
      s_act_rf = rtb_Abs1_f / rtb_steer_dem;

      /* Saturate: '<S1158>/Saturation3' */
      rtb_DLookupTable3_e = s_act_rf;
      if (rtb_DLookupTable3_e > 2.0F) {
        rtb_Saturation3_l = 2.0F;
      } else if (rtb_DLookupTable3_e < 0.0F) {
        rtb_Saturation3_l = 0.0F;
      } else {
        rtb_Saturation3_l = rtb_DLookupTable3_e;
      }

      /* End of Saturate: '<S1158>/Saturation3' */
      ...
      s_act_rm = rtb_Abs1_f / rtb_steer_dem;

      /* Saturate: '<S1158>/Saturation4' */
      rtb_DLookupTable3_e = s_act_rm;
      if (rtb_DLookupTable3_e > 2.0F) {
        rtb_Saturation4_m = 2.0F;
      } else if (rtb_DLookupTable3_e < 0.0F) {
        rtb_Saturation4_m = 0.0F;
      } else {
        rtb_Saturation4_m = rtb_DLookupTable3_e;
      }

      /* End of Saturate: '<S1158>/Saturation4' */
      ...
      /* Saturate: '<S1158>/Saturation5' */
      rtb_DLookupTable3_e = s_act_rr;
      if (rtb_DLookupTable3_e > 2.0F) {
        rtb_Saturation5_e = 2.0F;
      } else if (rtb_DLookupTable3_e < 0.0F) {
        rtb_Saturation5_e = 0.0F;
      } else {
        rtb_Saturation5_e = rtb_DLookupTable3_e;
      }

      /* End of Saturate: '<S1158>/Saturation5' */

      /* Outputs for Atomic SubSystem: '<S1158>/直行' */
      /* Lookup_n-D: '<S1167>/1-D Lookup Table' */
      rtb_DLookupTable_g = look1_iflf_binlx
      ...
      /* MATLAB Function: '<S1167>/MATLAB Function' incorporates:
       *  Constant: '<S1167>/Constant7'
       */
      ...
      /* Memory: '<S1167>/Memory10' */
      rtb_Memory10_a = six_plus_six_AcmsteeringV09__DW.Memory10_PreviousInput_m;

      /* MATLAB Function: '<S1167>/MATLAB Function4' incorporates:
       *  Constant: '<S1167>/Constant12'
       */
      ...
      /* Memory: '<S1167>/Memory7' */
      rtb_Memory7_a = six_plus_six_AcmsteeringV09__DW.Memory7_PreviousInput_i;

      /* MATLAB Function: '<S1167>/MATLAB Function1' incorporates:
       *  Constant: '<S1167>/Constant8'
       */
      ...
      /* Memory: '<S1167>/Memory8' */
      rtb_Memory8_e = six_plus_six_AcmsteeringV09__DW.Memory8_PreviousInput_d;

      /* MATLAB Function: '<S1167>/MATLAB Function2' incorporates:
       *  Constant: '<S1167>/Constant9'
       */
      ...
      /* Memory: '<S1167>/Memory11' */
      rtb_Memory11_p = six_plus_six_AcmsteeringV09__DW.Memory11_PreviousInput_d;

      /* MATLAB Function: '<S1167>/MATLAB Function6' incorporates:
       *  Constant: '<S1167>/Constant13'
       */
      ...
      /* Memory: '<S1167>/Memory9' */
      rtb_Memory9_c = six_plus_six_AcmsteeringV09__DW.Memory9_PreviousInput_p;

      /* MATLAB Function: '<S1167>/MATLAB Function3' incorporates:
       *  Constant: '<S1167>/Constant10'
       */
      ...
      /* MATLAB Function: '<S1167>/MATLAB Function5' incorporates:
       *  Constant: '<S1167>/Constant11'
       */
      /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function5': '<S1179>:1' */
      if (TCS_switch == 0.0F) {
        /* '<S1179>:1:3' */
        /* '<S1179>:1:4' */
        flag_lf = 0.0F;
      ...
      /* End of MATLAB Function: '<S1167>/MATLAB Function5' */
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S1182>/Subsystem' incorporates:
           *  InitializeConditions for ActionPort: '<S1183>/Action Port'
           */
          /* InitializeConditions for If: '<S1182>/If' incorporates:
           *  InitializeConditions for Memory: '<S1183>/Memory13'
           *  InitializeConditions for Memory: '<S1183>/Memory3'
           *  InitializeConditions for Memory: '<S1183>/Memory4'
           *  InitializeConditions for Memory: '<S1183>/Memory5'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S1182>/Subsystem' */
        }

        /* Outputs for IfAction SubSystem: '<S1182>/Subsystem' incorporates:
         *  ActionPort: '<S1183>/Action Port'
         */
        /* Sum: '<S1183>/Sum' */
        rtb_steer_dem = rtb_DLookupTable_h - rtb_Saturation_a;

        /* Memory: '<S1183>/Memory4' */
        rtb_Abs1_f = six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_j;

        /* Gain: '<S1183>/Gain20' */
        rtb_acc_dem = 2.0F * rtb_Abs1_f;

        /* Memory: '<S1183>/Memory5' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_ny;

        /* Sum: '<S1183>/Add10' */
        rtb_acc_dem = (rtb_steer_dem - rtb_acc_dem) + rtb_Add2_c;

        /* Memory: '<S1183>/Memory3' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_o;

        /* Sum: '<S1183>/Subtract1' */
        rtb_Add2_c = rtb_steer_dem - rtb_Add2_c;
        ...
        /* Sum: '<S1183>/Add2' */
        rtb_Add2_c = (rtb_Add2_c + rtb_steer_dem) + rtb_acc_dem;

        /* Memory: '<S1183>/Memory13' */
        ...
        /* Sum: '<S1183>/Add3' */
        rtb_Add2_c = trq_pid_lf_adjust +
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_o.trq_dem_lf;

        /* Saturate: '<S1183>/Saturation' */
        if (rtb_Add2_c <= 0.0F) {
          rtb_Add2_c = 0.0F;
        }

        /* End of Saturate: '<S1183>/Saturation' */

        /* DataTypeConversion: '<S1183>/Data Type Conversion' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_oe = rtb_Add2_c;

        /* Update for Memory: '<S1183>/Memory4' */
        six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_j = rtb_steer_dem;

        /* Update for Memory: '<S1183>/Memory5' */
        six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_ny = rtb_Abs1_f;

        /* Update for Memory: '<S1183>/Memory3' */
        six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_o = rtb_steer_dem;

        /* Update for Memory: '<S1183>/Memory13' */
        six_plus_six_AcmsteeringV09__DW.Memory13_PreviousInput_i = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S1182>/Subsystem' */
      }
      ...
      /* Switch: '<S1182>/Switch' */
      if (flag_lf > 0.5F) {
        rtb_mot_map_a = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_oe;
      } else {
        rtb_mot_map_a =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_o.trq_dem_lf;
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S1182>/Subsystem4' incorporates:
           *  InitializeConditions for ActionPort: '<S1187>/Action Port'
           */
          /* InitializeConditions for If: '<S1182>/If4' incorporates:
           *  InitializeConditions for Memory: '<S1187>/Memory13'
           *  InitializeConditions for Memory: '<S1187>/Memory3'
           *  InitializeConditions for Memory: '<S1187>/Memory4'
           *  InitializeConditions for Memory: '<S1187>/Memory5'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S1182>/Subsystem4' */
        }

        /* Outputs for IfAction SubSystem: '<S1182>/Subsystem4' incorporates:
         *  ActionPort: '<S1187>/Action Port'
         */
        /* Sum: '<S1187>/Sum' */
        rtb_steer_dem = rtb_DLookupTable_h - rtb_Saturation1_j;

        /* Memory: '<S1187>/Memory4' */
        rtb_brake_dem = six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_dl;

        /* Gain: '<S1187>/Gain20' */
        rtb_acc_dem = 2.0F * rtb_brake_dem;

        /* Memory: '<S1187>/Memory5' */
        rtb_Abs1_f = six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_c;

        /* Sum: '<S1187>/Add10' */
        rtb_acc_dem = (rtb_steer_dem - rtb_acc_dem) + rtb_Abs1_f;

        /* Memory: '<S1187>/Memory3' */
        rtb_Abs1_f = six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_h;
        ...
        /* Sum: '<S1187>/Add2' */
        rtb_Abs1_f = (rtb_Abs1_f + rtb_steer_dem) + rtb_acc_dem;

        /* Memory: '<S1187>/Memory13' */
        rtb_acc_dem = six_plus_six_AcmsteeringV09__DW.Memory13_PreviousInput_oa;

        /* Sum: '<S1187>/Subtract5' */
        rtb_acc_dem += rtb_Abs1_f;

        /* Gain: '<S1187>/Gain' */
        trq_pid_lm_adjust = 0.125F * rtb_acc_dem;

        /* Sum: '<S1187>/Add3' */
        rtb_Abs1_f = trq_pid_lm_adjust +
        ...
        /* DataTypeConversion: '<S1187>/Data Type Conversion' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_o = rtb_Abs1_f;

        /* Update for Memory: '<S1187>/Memory4' */
        six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_dl = rtb_steer_dem;

        /* Update for Memory: '<S1187>/Memory5' */
        six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_c = rtb_brake_dem;

        /* Update for Memory: '<S1187>/Memory3' */
        six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_h = rtb_steer_dem;

        /* Update for Memory: '<S1187>/Memory13' */
        six_plus_six_AcmsteeringV09__DW.Memory13_PreviousInput_oa = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S1182>/Subsystem4' */
      }

      /* End of If: '<S1182>/If4' */

      /* Switch: '<S1182>/Switch4' */
      if (flag_lm > 0.5F) {
        rtb_Abs10_n = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_o;
      } else {
        rtb_Abs10_n =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_o.trq_dem_lm;
      }

      /* End of Switch: '<S1182>/Switch4' */
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S1182>/Subsystem1' incorporates:
           *  InitializeConditions for ActionPort: '<S1184>/Action Port'
           */
          /* InitializeConditions for If: '<S1182>/If1' incorporates:
          ...
          /* End of InitializeConditions for SubSystem: '<S1182>/Subsystem1' */
        }

        /* Outputs for IfAction SubSystem: '<S1182>/Subsystem1' incorporates:
        ...
        rtb_Abs1_f = six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_m;

        /* Gain: '<S1184>/Gain20' */
        rtb_acc_dem = 2.0F * rtb_Abs1_f;

        /* Memory: '<S1184>/Memory5' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_cd;

        /* Sum: '<S1184>/Add10' */
        rtb_acc_dem = (rtb_steer_dem - rtb_acc_dem) + rtb_Add2_c;

        /* Memory: '<S1184>/Memory3' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_g2;
        ...
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_n = rtb_Add2_c;
        ...
        six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_cd = rtb_Abs1_f;
        ...
        /* End of Outputs for SubSystem: '<S1182>/Subsystem1' */
      }
      ...
      if (flag_lr > 0.5F) {
        rtb_Abs14_m = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_n;
      } else {
        rtb_Abs14_m =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_o.trq_dem_lr;
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S1182>/Subsystem2' incorporates:
           *  InitializeConditions for ActionPort: '<S1185>/Action Port'
           */
          /* InitializeConditions for If: '<S1182>/If2' incorporates:
           *  InitializeConditions for Memory: '<S1185>/Memory1'
           *  InitializeConditions for Memory: '<S1185>/Memory15'
           *  InitializeConditions for Memory: '<S1185>/Memory2'
           *  InitializeConditions for Memory: '<S1185>/Memory6'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S1182>/Subsystem2' */
        }

        /* Outputs for IfAction SubSystem: '<S1182>/Subsystem2' incorporates:
         *  ActionPort: '<S1185>/Action Port'
         */
        /* Sum: '<S1185>/Sum3' */
        rtb_Abs1_f = rtb_DLookupTable_h - rtb_Saturation3_l;

        /* Memory: '<S1185>/Memory1' */
        rtb_acc_dem = six_plus_six_AcmsteeringV09__DW.Memory1_PreviousInput_mg;

        /* Sum: '<S1185>/Subtract2' */
        rtb_acc_dem = rtb_Abs1_f - rtb_acc_dem;

        /* Gain: '<S1185>/Gain16' */
        rtb_acc_dem *= 300.0F;

        /* Memory: '<S1185>/Memory2' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_l;

        /* Gain: '<S1185>/Gain18' */
        rtb_steer_dem = 2.0F * rtb_Add2_c;

        /* Memory: '<S1185>/Memory6' */
        rtb_Gain_p = six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_h;

        /* Sum: '<S1185>/Add9' */
        rtb_steer_dem = (rtb_Abs1_f - rtb_steer_dem) + rtb_Gain_p;

        /* Gain: '<S1185>/Gain19' */
        rtb_steer_dem *= 0.0F;

        /* Sum: '<S1185>/Add11' */
        rtb_acc_dem = (rtb_acc_dem + rtb_Abs1_f) + rtb_steer_dem;

        /* Memory: '<S1185>/Memory15' */
        rtb_Gain_p = six_plus_six_AcmsteeringV09__DW.Memory15_PreviousInput_m;

        /* Sum: '<S1185>/Subtract7' */
        rtb_acc_dem += rtb_Gain_p;

        /* Gain: '<S1185>/Gain14' */
        trq_pid_rf_adjust = 0.125F * rtb_acc_dem;

        /* Sum: '<S1185>/Add8' */
        rtb_Gain_p = trq_pid_rf_adjust +
        ...
        /* DataTypeConversion: '<S1185>/Data Type Conversion2' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion2_m = rtb_Gain_p;

        /* Update for Memory: '<S1185>/Memory1' */
        six_plus_six_AcmsteeringV09__DW.Memory1_PreviousInput_mg = rtb_Abs1_f;

        /* Update for Memory: '<S1185>/Memory2' */
        six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_l = rtb_Abs1_f;

        /* Update for Memory: '<S1185>/Memory6' */
        six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_h = rtb_Add2_c;

        /* Update for Memory: '<S1185>/Memory15' */
        six_plus_six_AcmsteeringV09__DW.Memory15_PreviousInput_m = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S1182>/Subsystem2' */
      }
      ...
      if (flag_rf > 0.5F) {
        rtb_brake_dem = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion2_m;
      } else {
        rtb_brake_dem =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_o.trq_dem_rf;
      }

      /* End of Switch: '<S1182>/Switch3' */
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S1182>/Subsystem5' incorporates:
           *  InitializeConditions for ActionPort: '<S1188>/Action Port'
           */
          /* InitializeConditions for If: '<S1182>/If5' incorporates:
           *  InitializeConditions for Memory: '<S1188>/Memory1'
           *  InitializeConditions for Memory: '<S1188>/Memory15'
           *  InitializeConditions for Memory: '<S1188>/Memory2'
           *  InitializeConditions for Memory: '<S1188>/Memory6'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S1182>/Subsystem5' */
        }

        /* Outputs for IfAction SubSystem: '<S1182>/Subsystem5' incorporates:
         *  ActionPort: '<S1188>/Action Port'
         */
        /* Sum: '<S1188>/Sum3' */
        rtb_Add2_c = rtb_DLookupTable_h - rtb_Saturation4_m;

        /* Memory: '<S1188>/Memory1' */
        rtb_acc_dem = six_plus_six_AcmsteeringV09__DW.Memory1_PreviousInput_o5;

        /* Sum: '<S1188>/Subtract2' */
        rtb_acc_dem = rtb_Add2_c - rtb_acc_dem;

        /* Gain: '<S1188>/Gain16' */
        rtb_acc_dem *= 300.0F;

        /* Memory: '<S1188>/Memory2' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_nz;

        /* Gain: '<S1188>/Gain18' */
        rtb_steer_dem = 2.0F * rtb_Gain5_d;

        /* Memory: '<S1188>/Memory6' */
        rtb_Saturation3_m =
          six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_pi;

        /* Sum: '<S1188>/Add9' */
        rtb_steer_dem = (rtb_Add2_c - rtb_steer_dem) + rtb_Saturation3_m;

        /* Gain: '<S1188>/Gain19' */
        rtb_steer_dem *= 0.0F;

        /* Sum: '<S1188>/Add11' */
        rtb_acc_dem = (rtb_acc_dem + rtb_Add2_c) + rtb_steer_dem;

        /* Memory: '<S1188>/Memory15' */
        rtb_Saturation3_m =
          six_plus_six_AcmsteeringV09__DW.Memory15_PreviousInput_i;
        ...
        /* Sum: '<S1188>/Add8' */
        rtb_Saturation3_m = trq_pid_rm_adjust +
        ...
        /* DataTypeConversion: '<S1188>/Data Type Conversion2' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion2_p =
          rtb_Saturation3_m;

        /* Update for Memory: '<S1188>/Memory1' */
        six_plus_six_AcmsteeringV09__DW.Memory1_PreviousInput_o5 = rtb_Add2_c;

        /* Update for Memory: '<S1188>/Memory2' */
        six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_nz = rtb_Add2_c;

        /* Update for Memory: '<S1188>/Memory6' */
        six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_pi = rtb_Gain5_d;

        /* Update for Memory: '<S1188>/Memory15' */
        six_plus_six_AcmsteeringV09__DW.Memory15_PreviousInput_i = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S1182>/Subsystem5' */
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S1182>/Subsystem3' incorporates:
           *  InitializeConditions for ActionPort: '<S1186>/Action Port'
           */
          /* InitializeConditions for If: '<S1182>/If3' incorporates:
           *  InitializeConditions for Memory: '<S1186>/Memory16'
           *  InitializeConditions for Memory: '<S1186>/Memory7'
           *  InitializeConditions for Memory: '<S1186>/Memory8'
           *  InitializeConditions for Memory: '<S1186>/Memory9'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S1182>/Subsystem3' */
        }

        /* Outputs for IfAction SubSystem: '<S1182>/Subsystem3' incorporates:
         *  ActionPort: '<S1186>/Action Port'
         */
        /* Sum: '<S1186>/Sum2' */
        rtb_steer_dem = rtb_DLookupTable_h - rtb_Saturation5_e;

        /* Memory: '<S1186>/Memory8' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory8_PreviousInput_a;

        /* Gain: '<S1186>/Gain23' */
        rtb_acc_dem = 2.0F * rtb_Add2_c;

        /* Memory: '<S1186>/Memory9' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory9_PreviousInput_i;

        /* Sum: '<S1186>/Add12' */
        rtb_acc_dem = (rtb_steer_dem - rtb_acc_dem) + rtb_Gain5_d;

        /* Memory: '<S1186>/Memory7' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory7_PreviousInput_n;

        /* Sum: '<S1186>/Subtract3' */
        rtb_Gain5_d = rtb_steer_dem - rtb_Gain5_d;
        ...
        /* Sum: '<S1186>/Add13' */
        rtb_Gain5_d = (rtb_Gain5_d + rtb_steer_dem) + rtb_acc_dem;

        /* Memory: '<S1186>/Memory16' */
        ...
        /* DataTypeConversion: '<S1186>/Data Type Conversion3' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion3_a = rtb_Gain5_d;

        /* Update for Memory: '<S1186>/Memory8' */
        six_plus_six_AcmsteeringV09__DW.Memory8_PreviousInput_a = rtb_steer_dem;

        /* Update for Memory: '<S1186>/Memory9' */
        six_plus_six_AcmsteeringV09__DW.Memory9_PreviousInput_i = rtb_Add2_c;

        /* Update for Memory: '<S1186>/Memory7' */
        six_plus_six_AcmsteeringV09__DW.Memory7_PreviousInput_n = rtb_steer_dem;

        /* Update for Memory: '<S1186>/Memory16' */
        six_plus_six_AcmsteeringV09__DW.Memory16_PreviousInput_b = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S1182>/Subsystem3' */
      }
      ...
      /* End of Switch: '<S1182>/Switch2' */

      /* MATLAB Function: '<S1167>/MATLAB Function7' */
      /* MATLAB Function 'MainControl/mode_control/forward/forward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function7': '<S1181>:1' */
      if ((flag_lf == 0.0F) && (flag_lm == 0.0F) && (flag_lr == 0.0F) &&
        ...
        if (rtb_acc_dem >= 0.0F) {
          /* '<S1181>:1:748' */
          /* '<S1181>:1:749' */
          rtb_brake_dem -= rtb_acc_dem / 3.0F;
          ...
          /* '<S1181>:1:753' */
          rtb_mot_map_a += rtb_acc_dem / 3.0F;

          /* '<S1181>:1:754' */
          rtb_Abs10_n += rtb_acc_dem / 3.0F;
      ...
      /* '<S1181>:1:770' */
      /* '<S1181>:1:771' */
      trq_out_lf_forward = rtb_mot_map_a;
      trq_out_lm_forward = rtb_Abs10_n;
      trq_out_lr_forward = rtb_Abs14_m;
      trq_out_rf_forward = rtb_brake_dem;
      trq_out_rm_forward = rtb_Saturation3_m;
      trq_out_rr_forward = rtb_steer_dem;

      /* End of MATLAB Function: '<S1167>/MATLAB Function7' */

      /* Saturate: '<S1167>/Saturation4' */
      ...
      /* End of Saturate: '<S1167>/Saturation4' */

      /* Lookup_n-D: '<S1167>/1-D Lookup Table1' */
      ...
      /* End of Saturate: '<S1167>/Saturation10' */

      /* Saturate: '<S1167>/Saturation11' */
      if (rtb_steer_dem > 750000.0F) {
        rtb_Abs14_m = 750000.0F;
      } else if (rtb_steer_dem < -140000.0F) {
        rtb_Abs14_m = -140000.0F;
      } else {
        rtb_Abs14_m = rtb_steer_dem;
      }

      /* End of Saturate: '<S1167>/Saturation11' */

      /* Saturate: '<S1167>/Saturation8' */
      if (rtb_DLookupTable_g > 400000.0F) {
        rtb_DLookupTable_g = 400000.0F;
      } else {
        if (rtb_DLookupTable_g < -400000.0F) {
          rtb_DLookupTable_g = -400000.0F;
        }
      ...
      /* End of Saturate: '<S1167>/Saturation8' */

      /* Saturate: '<S1167>/Saturation9' */
      if (rtb_Gain_p > 400000.0F) {
        rtb_steer_dem = 400000.0F;
      } else if (rtb_Gain_p < -400000.0F) {
        rtb_steer_dem = -400000.0F;
      } else {
        rtb_steer_dem = rtb_Gain_p;
      }

      /* End of Saturate: '<S1167>/Saturation9' */
       ...
       *  Constant: '<S1167>/Constant3'
       *  Constant: '<S1167>/Constant4'
       *  Constant: '<S1167>/Constant5'
       *  Constant: '<S1167>/Constant6'
       *  Constant: '<S1167>/SpdSet_dem'
       *  Constant: '<S1167>/SpdSet_dem1'
       *  Constant: '<S1167>/SpdSet_dem2'
       *  Constant: '<S1167>/SpdSet_dem3'
       *  Constant: '<S1167>/SpdSet_dem4'
       *  Constant: '<S1167>/SpdSet_dem5'
       *  Constant: '<S1167>/mot_mode'
       *  Constant: '<S1167>/mot_mode1'
       *  Constant: '<S1167>/mot_mode10'
       *  Constant: '<S1167>/mot_mode11'
       *  Constant: '<S1167>/mot_mode2'
       *  Constant: '<S1167>/mot_mode3'
       *  Constant: '<S1167>/mot_mode4'
       *  Constant: '<S1167>/mot_mode5'
       *  Constant: '<S1167>/mot_mode6'
       *  Constant: '<S1167>/mot_mode7'
       *  Constant: '<S1167>/mot_mode8'
       *  Constant: '<S1167>/mot_mode9'
       *  Switch: '<S1167>/Switch1'
       *  Switch: '<S1167>/Switch10'
       *  Switch: '<S1167>/Switch11'
       *  Switch: '<S1167>/Switch12'
       *  Switch: '<S1167>/Switch13'
       *  Switch: '<S1167>/Switch14'
       *  Switch: '<S1167>/Switch15'
       *  Switch: '<S1167>/Switch16'
       *  Switch: '<S1167>/Switch17'
       *  Switch: '<S1167>/Switch2'
       *  Switch: '<S1167>/Switch3'
       *  Switch: '<S1167>/Switch4'
       *  Switch: '<S1167>/Switch5'
       *  Switch: '<S1167>/Switch6'
       *  Switch: '<S1167>/Switch7'
       *  Switch: '<S1167>/Switch8'
       *  Switch: '<S1167>/Switch9'
       */
      if (Compare_i) {
        rtb_Add2_c = 1.0F;

        /* Lookup_n-D: '<S1167>/1-D Lookup Table2' incorporates:
         *  Constant: '<S1167>/mot_mode6'
         */
        brake_dem = look1_iflf_binlx(acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);

        /* Lookup_n-D: '<S1167>/1-D Lookup Table4' */
        rtb_Abs8_m = look1_iflf_binlx(acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);

        /* Lookup_n-D: '<S1167>/1-D Lookup Table5' */
        rtb_Abs9_p = look1_iflf_binlx(acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);

        /* Lookup_n-D: '<S1167>/1-D Lookup Table6' */
        rtb_DLookupTable6_p = look1_iflf_binlx(acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);

        /* Lookup_n-D: '<S1167>/1-D Lookup Table7' */
        rtb_DLookupTable7_e = look1_iflf_binlx(acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);
        rtb_Gain5_d = 0.0F;
        rtb_Saturation3_m = 0.0F;
        ...
        /* Lookup_n-D: '<S1167>/1-D Lookup Table3' incorporates:
         *  Constant: '<S1167>/Constant'
         *  Constant: '<S1167>/Constant3'
         *  Constant: '<S1167>/Constant4'
         *  Constant: '<S1167>/Constant5'
         ...
         *  Constant: '<S1167>/mot_mode9'
         */
        rtb_DLookupTable3_e = look1_iflf_binlx(acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);
        rtb_acc_dem = 0.0F;
      } else {
        ...
        rtb_Abs8_m = 0.0F;
        rtb_Abs9_p = 0.0F;
        rtb_DLookupTable6_p = 0.0F;
        rtb_DLookupTable7_e = 0.0F;

        /* Saturate: '<S1167>/Saturation6' incorporates:
         *  Constant: '<S1167>/SpdSet_dem'
         *  Constant: '<S1167>/SpdSet_dem2'
         *  Constant: '<S1167>/SpdSet_dem3'
         *  Constant: '<S1167>/SpdSet_dem4'
         ...
         *  Constant: '<S1167>/mot_mode'
         */
        rtb_Gain5_d = trq_out_lm_forward;
        if (rtb_Gain5_d > 70.5F) {
          rtb_Gain5_d = 70.5F;
        } else {
          if (rtb_Gain5_d < -70.5F) {
            rtb_Gain5_d = -70.5F;
        ...
        /* End of Saturate: '<S1167>/Saturation6' */

        /* Saturate: '<S1167>/Saturation7' */
        rtb_Saturation3_m = trq_out_rm_forward;
        ...
        /* End of Saturate: '<S1167>/Saturation7' */

        /* Saturate: '<S1167>/Saturation1' */
        rtb_brake_dem = trq_out_lr_forward;
        ...
        /* End of Saturate: '<S1167>/Saturation1' */

        /* Saturate: '<S1167>/Saturation3' */
        rtb_Gain_p = trq_out_rr_forward;
        if (rtb_Gain_p > 70.5F) {
          rtb_Gain_p = 70.5F;
        } else {
          if (rtb_Gain_p < -70.5F) {
        ...
        /* End of Saturate: '<S1167>/Saturation3' */

        /* Saturate: '<S1167>/Saturation' */
        rtb_Abs1_f = trq_out_lf_forward;
        if (rtb_Abs1_f > 70.5F) {
          rtb_Abs1_f = 70.5F;
        } else {
          if (rtb_Abs1_f < -70.5F) {
        ...
        /* End of Saturate: '<S1167>/Saturation' */
        rtb_Abs10_n = 0.0F;
        rtb_mot_map_a = 0.0F;
        rtb_mot_map1_j = 0.0F;
        rtb_mot_map4_k = 0.0F;
        rtb_mot_map5_p = 0.0F;
        rtb_DLookupTable3_e = 0.0F;

        /* Saturate: '<S1167>/Saturation2' incorporates:
         *  Constant: '<S1167>/SpdSet_dem1'
         *  Constant: '<S1167>/mot_mode1'
         *  Constant: '<S1167>/mot_mode2'
         *  Constant: '<S1167>/mot_mode3'
         ...
         *  Constant: '<S1167>/mot_mode5'
         */
        rtb_acc_dem = trq_out_rf_forward;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[7] =
        rtb_mot_map_a;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[8] = 1.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[9] =
        rtb_Abs8_m;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[13] =
        rtb_mot_map4_k;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[14] = 1.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[15] =
        rtb_DLookupTable6_p;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[19] =
        rtb_Abs10_n;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[20] = 2.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[21] =
        rtb_DLookupTable3_e;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[25] =
        rtb_mot_map1_j;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[26] = 2.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[27] =
        rtb_Abs9_p;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[31] =
        rtb_mot_map5_p;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[32] = 2.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForforward_dem_b[33] =
        rtb_DLookupTable7_e;
      ...
      /* Outputs for Atomic SubSystem: '<S879>/目标转向力矩确定模块' */
      six_plus_six_AcmsteeringV_u(rtb_Abs15_g, rtb_Abs16_n, rtb_Abs17_g,
        rtb_Abs18_p, rtb_Abs21_a, rtb_Abs22_m);

      /* End of Outputs for SubSystem: '<S879>/目标转向力矩确定模块' */

      /* End of Outputs for SubSystem: '<S877>/Drive' */
      break;

     case 1:
      /* Outputs for IfAction SubSystem: '<S877>/Brake' incorporates:
       *  ActionPort: '<S878>/Action Port'
       */
      /* Lookup_n-D: '<S878>/1-D Lookup Table1' */
      rtb_Abs10_n = look1_iflf_binlx(six_plus_six_AcmsteeringV09_m_B.steer_dem,
        six_plus_six_Acmsteering_ConstP.pooled41,
        six_plus_six_Acmsteering_ConstP.pooled40, 2U);

      /* Lookup_n-D: '<S878>/1-D Lookup Table2' */
      rtb_mot_map_a = look1_iflf_binlx(brake_dem,
        six_plus_six_Acmsteering_ConstP.pooled46,
        six_plus_six_Acmsteering_ConstP.pooled45, 1U);
      ...
      /* DataTypeConversion: '<S878>/Data Type Conversion1' */
      rtb_y = rtb_acc_dem;
      ...
      /* Gain: '<S878>/Gain1' */
      rtb_acc_dem = 0.5F * rtb_Abs10_n;

      /* Gain: '<S878>/Gain3' */
      rtb_steer_dem = -rtb_Abs10_n;

      /* Memory: '<S878>/Memory4' */
      rtb_Memory4_a = six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_bi;

      /* MATLAB Function: '<S878>/HeartBeat' */
      ...
      /* MATLAB Function: '<S878>/HeartBeat1' */
      ...
      /* MATLAB Function: '<S878>/HeartBeat2' */
      ...
      /* MATLAB Function: '<S878>/HeartBeat3' */
      ...
      /* MATLAB Function: '<S878>/HeartBeat4' */
      ...
      /* MATLAB Function: '<S878>/HeartBeat5' */
      six_plus_six_Acms_HeartBeat(rtb_Memory6_h1,
        &six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat5_k);

      /* Saturate: '<S878>/Saturation8' */
      if (rtb_Abs10_n > 400000.0F) {
        rtb_Abs10_n = 400000.0F;
      } else {
        if (rtb_Abs10_n < -400000.0F) {
          rtb_Abs10_n = -400000.0F;
        }
      ...
      /* End of Saturate: '<S878>/Saturation8' */

      /* Saturate: '<S878>/Saturation9' */
      if (rtb_acc_dem > 400000.0F) {
        rtb_acc_dem = 400000.0F;
      } else {
        if (rtb_acc_dem < -400000.0F) {
      ...
      /* End of Saturate: '<S878>/Saturation9' */

      /* Saturate: '<S878>/Saturation10' */
      if (rtb_steer_dem > 400000.0F) {
        rtb_steer_dem = 400000.0F;
      } else {
        if (rtb_steer_dem < -400000.0F) {
      ...
      /* End of Saturate: '<S878>/Saturation10' */

      /* Saturate: '<S878>/Saturation11' */
      if (rtb_mot_map_a > 750000.0F) {
        rtb_mot_map_a = 750000.0F;
      } else {
        if (rtb_mot_map_a < -140000.0F) {
          rtb_mot_map_a = -140000.0F;
        }
      }

      /* End of Saturate: '<S878>/Saturation11' */

      /* SignalConversion: '<S878>/OutportBufferForforward_dem' incorporates:
       *  Constant: '<S878>/SpdSet_dem'
       *  Constant: '<S878>/SpdSet_dem1'
       *  Constant: '<S878>/SpdSet_dem2'
       *  Constant: '<S878>/SpdSet_dem3'
       *  Constant: '<S878>/SpdSet_dem4'
       *  Constant: '<S878>/SpdSet_dem5'
       *  Constant: '<S878>/mot_enable1'
       *  Constant: '<S878>/mot_enable2'
       *  Constant: '<S878>/mot_enable3'
       *  Constant: '<S878>/mot_enable4'
       *  Constant: '<S878>/mot_enable5'
       *  Constant: '<S878>/mot_enable6'
       *  Constant: '<S878>/mot_gear'
       *  Constant: '<S878>/mot_gear1'
       *  Constant: '<S878>/mot_gear2'
       *  Constant: '<S878>/mot_gear3'
       *  Constant: '<S878>/mot_gear4'
       *  Constant: '<S878>/mot_gear5'
       *  Constant: '<S878>/mot_mode'
       *  Constant: '<S878>/mot_mode1'
       *  Constant: '<S878>/mot_mode2'
       *  Constant: '<S878>/mot_mode3'
       *  Constant: '<S878>/mot_mode4'
       *  Constant: '<S878>/mot_mode5'
       */
       ...
       */
      Compare_g = (six_plus_six_AcmsteeringV09_m_B.Signals[255] == 1.0);

      /* RelationalOperator: '<S899>/Compare' incorporates:
       *  Constant: '<S899>/Constant'
       */
      Compare_p = (six_plus_six_AcmsteeringV09_m_B.Signals[256] == 1.0);

      /* RelationalOperator: '<S900>/Compare' incorporates:
       *  Constant: '<S900>/Constant'
       */
      Compare_i = (six_plus_six_AcmsteeringV09_m_B.Signals[257] == 1.0);

      /* RelationalOperator: '<S901>/Compare' incorporates:
       *  Constant: '<S901>/Constant'
       */
      rtb_Compare_n5 = (six_plus_six_AcmsteeringV09_m_B.Signals[258] == 1.0);

      /* RelationalOperator: '<S902>/Compare' incorporates:
       *  Constant: '<S902>/Constant'
       */
      rtb_Compare_b2y = (six_plus_six_AcmsteeringV09_m_B.Signals[259] == 1.0);

      /* RelationalOperator: '<S903>/Compare' incorporates:
       *  Constant: '<S903>/Constant'
       */
      rtb_Compare_atf = (six_plus_six_AcmsteeringV09_m_B.Signals[260] == 1.0);

      /* RelationalOperator: '<S904>/Compare' incorporates:
       *  Constant: '<S904>/Constant'
       */
      rtb_Compare_l3 = (six_plus_six_AcmsteeringV09_m_B.Signals[261] == 1.0);

      /* RelationalOperator: '<S905>/Compare' incorporates:
       *  Constant: '<S905>/Constant'
       */
      rtb_Compare_ix = (six_plus_six_AcmsteeringV09_m_B.Signals[262] == 1.0);

      /* RelationalOperator: '<S906>/Compare' incorporates:
       *  Constant: '<S906>/Constant'
       */
      rtb_Compare_dc = (six_plus_six_AcmsteeringV09_m_B.Signals[263] == 1.0);

      /* RelationalOperator: '<S907>/Compare' incorporates:
       *  Constant: '<S907>/Constant'
       */
      rtb_Compare_f3 = (six_plus_six_AcmsteeringV09_m_B.Signals[246] == 1.0);

      /* RelationalOperator: '<S908>/Compare' incorporates:
       *  Constant: '<S908>/Constant'
       */
      rtb_Compare_c = (six_plus_six_AcmsteeringV09_m_B.Signals[247] == 1.0);

      /* RelationalOperator: '<S909>/Compare' incorporates:
       *  Constant: '<S909>/Constant'
       */
      rtb_Compare_nr = (six_plus_six_AcmsteeringV09_m_B.Signals[248] == 1.0);

      /* RelationalOperator: '<S910>/Compare' incorporates:
       *  Constant: '<S910>/Constant'
       */
      rtb_Compare_ag = (six_plus_six_AcmsteeringV09_m_B.Signals[249] == 1.0);

      /* RelationalOperator: '<S911>/Compare' incorporates:
       *  Constant: '<S911>/Constant'
       */
      rtb_Compare_op = (six_plus_six_AcmsteeringV09_m_B.Signals[250] == 1.0);

      /* RelationalOperator: '<S912>/Compare' incorporates:
       *  Constant: '<S912>/Constant'
       */
      rtb_Compare_kx = (six_plus_six_AcmsteeringV09_m_B.Signals[251] == 1.0);

      /* RelationalOperator: '<S913>/Compare' incorporates:
       *  Constant: '<S913>/Constant'
       */
      rtb_Compare_gq = (six_plus_six_AcmsteeringV09_m_B.Signals[252] == 1.0);

      /* RelationalOperator: '<S914>/Compare' incorporates:
       *  Constant: '<S914>/Constant'
       */
      rtb_Compare_iu = (six_plus_six_AcmsteeringV09_m_B.Signals[253] == 1.0);

      /* Logic: '<S887>/Logical Operator' */
      rtb_LogicalOperator_an = (rtb_Compare || rtb_Compare_ak || rtb_Compare_f3 ||
        rtb_Compare_c || rtb_Compare_nr || rtb_Compare_ag || rtb_Compare_op ||
        rtb_Compare_kx || rtb_Compare_gq || rtb_Compare_iu || Compare ||
        Compare_g || Compare_p || Compare_i || rtb_Compare_n5 || rtb_Compare_b2y
        || rtb_Compare_atf || rtb_Compare_l3 || rtb_Compare_ix || rtb_Compare_dc);

      /* Lookup_n-D: '<S888>/mot_map' */
      rtb_mot_map_g = look1_iflf_binlx(rtb_Abs14_l,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S888>/mot_map4' */
      rtb_mot_map4_p = look1_iflf_binlx(rtb_Abs15_h,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S888>/mot_map1' */
      rtb_mot_map1_o = look1_iflf_binlx(rtb_Abs16_o,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S888>/mot_map2' */
      rtb_mot_map2_n = look1_iflf_binlx(rtb_Abs17_c,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S888>/mot_map5' */
      rtb_mot_map5_b = look1_iflf_binlx(rtb_Abs18_b,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S888>/mot_map3' */
      ...
      rtb_LogicalOperator_gi = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
        rtb_Compare_atf);

      /* RelationalOperator: '<S935>/Compare' incorporates:
       *  Constant: '<S935>/Constant'
       */
      rtb_Compare_iu = (six_plus_six_AcmsteeringV09_m_B.Signals[104] == 1.0);

      /* RelationalOperator: '<S936>/Compare' incorporates:
       *  Constant: '<S936>/Constant'
       */
      rtb_Compare_gq = (six_plus_six_AcmsteeringV09_m_B.Signals[105] == 1.0);

      /* RelationalOperator: '<S937>/Compare' incorporates:
       *  Constant: '<S937>/Constant'
       */
      rtb_Compare_kx = (six_plus_six_AcmsteeringV09_m_B.Signals[114] == 1.0);

      /* RelationalOperator: '<S938>/Compare' incorporates:
       *  Constant: '<S938>/Constant'
       */
      rtb_Compare_op = (six_plus_six_AcmsteeringV09_m_B.Signals[115] == 1.0);

      /* RelationalOperator: '<S939>/Compare' incorporates:
       *  Constant: '<S939>/Constant'
       */
      rtb_Compare_ag = (six_plus_six_AcmsteeringV09_m_B.Signals[116] == 1.0);

      /* RelationalOperator: '<S940>/Compare' incorporates:
       *  Constant: '<S940>/Constant'
       */
      rtb_Compare_nr = (six_plus_six_AcmsteeringV09_m_B.Signals[117] == 1.0);

      /* RelationalOperator: '<S941>/Compare' incorporates:
       *  Constant: '<S941>/Constant'
       */
      rtb_Compare_c = (six_plus_six_AcmsteeringV09_m_B.Signals[118] == 1.0);

      /* RelationalOperator: '<S942>/Compare' incorporates:
       *  Constant: '<S942>/Constant'
       */
      rtb_Compare_f3 = (six_plus_six_AcmsteeringV09_m_B.Signals[119] == 1.0);

      /* RelationalOperator: '<S943>/Compare' incorporates:
       *  Constant: '<S943>/Constant'
       */
      rtb_Compare_dc = (six_plus_six_AcmsteeringV09_m_B.Signals[120] == 1.0);

      /* RelationalOperator: '<S944>/Compare' incorporates:
       *  Constant: '<S944>/Constant'
       */
      rtb_Compare_ix = (six_plus_six_AcmsteeringV09_m_B.Signals[121] == 1.0);

      /* RelationalOperator: '<S945>/Compare' incorporates:
       *  Constant: '<S945>/Constant'
       */
      rtb_Compare_l3 = (six_plus_six_AcmsteeringV09_m_B.Signals[122] == 1.0);

      /* RelationalOperator: '<S946>/Compare' incorporates:
       *  Constant: '<S946>/Constant'
       */
      rtb_Compare_atf = (six_plus_six_AcmsteeringV09_m_B.Signals[123] == 1.0);

      /* RelationalOperator: '<S947>/Compare' incorporates:
       *  Constant: '<S947>/Constant'
       */
      rtb_Compare_b2y = (six_plus_six_AcmsteeringV09_m_B.Signals[106] == 1.0);

      /* RelationalOperator: '<S948>/Compare' incorporates:
       *  Constant: '<S948>/Constant'
       */
      rtb_Compare_n5 = (six_plus_six_AcmsteeringV09_m_B.Signals[107] == 1.0);

      /* RelationalOperator: '<S949>/Compare' incorporates:
       *  Constant: '<S949>/Constant'
       */
      Compare_i = (six_plus_six_AcmsteeringV09_m_B.Signals[108] == 1.0);

      /* RelationalOperator: '<S950>/Compare' incorporates:
       *  Constant: '<S950>/Constant'
       */
      Compare_p = (six_plus_six_AcmsteeringV09_m_B.Signals[109] == 1.0);

      /* RelationalOperator: '<S951>/Compare' incorporates:
       *  Constant: '<S951>/Constant'
       */
      Compare_g = (six_plus_six_AcmsteeringV09_m_B.Signals[110] == 1.0);
      ...
      rtb_LogicalOperator_j = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
      ...
      rtb_LogicalOperator_c = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
      ...
      rtb_LogicalOperator_jr = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
      ...
      rtb_LogicalOperator_pj = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
   ...
   case 2:
    ...
    /* MATLAB Function: '<S1189>/HeartBeat1' */
    ...
    /* MATLAB Function: '<S1189>/HeartBeat2' */
    ...
    /* Gain: '<S1189>/Gain' */
    rtb_steer_dem = 0.5F * rtb_Abs1_f;

    /* Saturate: '<S1189>/Saturation1' */
    if (rtb_steer_dem > 400000.0F) {
      rtb_steer_dem = 400000.0F;
    } else {
      if (rtb_steer_dem < -400000.0F) {
    ...
    /* End of Saturate: '<S1189>/Saturation1' */

    /* Gain: '<S1189>/Gain1' */
    rtb_Abs1_f = -rtb_Abs1_f;

    /* Saturate: '<S1189>/Saturation2' */
    if (rtb_Abs1_f > 400000.0F) {
      rtb_Abs1_f = 400000.0F;
    } else {
      if (rtb_Abs1_f < -400000.0F) {
        rtb_Abs1_f = -400000.0F;
      }
    ...
    /* End of Saturate: '<S1189>/Saturation2' */

    /* Lookup_n-D: '<S1189>/1-D Lookup Table2' */
    rtb_Add2_c = look1_iflf_binlx(brake_dem,
      six_plus_six_Acmsteering_ConstP.pooled46,
      six_plus_six_Acmsteering_ConstP.pooled45, 1U);

    /* Saturate: '<S1189>/Saturation3' */
    if (rtb_Add2_c > 750000.0F) {
      rtb_Add2_c = 750000.0F;
    } else {
      if (rtb_Add2_c < -140000.0F) {
        rtb_Add2_c = -140000.0F;
      }
    }

    /* End of Saturate: '<S1189>/Saturation3' */

    /* SignalConversion: '<S414>/OutportBufferForneutral_dem' incorporates:
     *  Constant: '<S1189>/SpdSet_dem'
     *  Constant: '<S1189>/SpdSet_dem1'
     *  Constant: '<S1189>/SpdSet_dem2'
     *  Constant: '<S1189>/SpdSet_dem3'
     *  Constant: '<S1189>/SpdSet_dem4'
     *  Constant: '<S1189>/SpdSet_dem5'
     *  Constant: '<S1189>/TrqSet_dem'
     *  Constant: '<S1189>/TrqSet_dem1'
     *  Constant: '<S1189>/TrqSet_dem2'
     *  Constant: '<S1189>/TrqSet_dem3'
     *  Constant: '<S1189>/TrqSet_dem4'
     *  Constant: '<S1189>/TrqSet_dem5'
     *  Constant: '<S1189>/mot_enable'
     *  Constant: '<S1189>/mot_enable1'
     *  Constant: '<S1189>/mot_enable2'
     *  Constant: '<S1189>/mot_enable3'
     *  Constant: '<S1189>/mot_enable4'
     *  Constant: '<S1189>/mot_enable5'
     *  Constant: '<S1189>/mot_gear'
     *  Constant: '<S1189>/mot_gear1'
     *  Constant: '<S1189>/mot_gear2'
     *  Constant: '<S1189>/mot_gear3'
     *  Constant: '<S1189>/mot_gear4'
     *  Constant: '<S1189>/mot_gear5'
     *  Constant: '<S1189>/mot_mode'
     *  Constant: '<S1189>/mot_mode1'
     *  Constant: '<S1189>/mot_mode2'
     *  Constant: '<S1189>/mot_mode3'
     *  Constant: '<S1189>/mot_mode4'
     *  Constant: '<S1189>/mot_mode5'
     */
    ...
    six_plus_six_AcmsteeringV09_m_B.OutportBufferForneutral_dem[37] =
      rtb_steer_dem;
    six_plus_six_AcmsteeringV09_m_B.OutportBufferForneutral_dem[38] = rtb_Abs1_f;
    six_plus_six_AcmsteeringV09_m_B.OutportBufferForneutral_dem[39] = rtb_Add2_c;

    /* Update for Memory: '<S1189>/Memory' */
    six_plus_six_AcmsteeringV09__DW.Memory_PreviousInput_f =
      six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat_b.life;

    /* Update for Memory: '<S1189>/Memory4' */
    ...
    /* Update for Memory: '<S1189>/Memory3' */
    six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_lm =
      six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat5_l.life;

    /* End of Outputs for SubSystem: '<S407>/neutral' */
    break;

   case 3:
    /* Outputs for IfAction SubSystem: '<S407>/backward' incorporates:
     *  ActionPort: '<S410>/Action Port'
     */
    /* MATLAB Function: '<S422>/MATLAB Function' */
    /* MATLAB Function 'MainControl/mode_control/backward/backward/MATLAB Function': '<S425>:1' */
    if (brake_dem == 0.0F) {
      /* '<S425>:1:10' */
      /* '<S425>:1:11' */
      rtb_y_o = 0;
    ...
    /* End of MATLAB Function: '<S422>/MATLAB Function' */

    /* SwitchCase: '<S422>/Switch Case1' incorporates:
    ...
    switch (rtAction) {
     case 0:
      /* Outputs for IfAction SubSystem: '<S422>/Drive' incorporates:
      ...
      /* End of Abs: '<S424>/Abs24' */

      /* Abs: '<S424>/Abs25' */
      rtb_Abs1 = (real32_T)fabs(acc_dem);
      ...
      switch (six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_b.y) {
       case 0:
        /* Outputs for IfAction SubSystem: '<S424>/车辆稳定性控制' incorporates:
        ...
        /* Gain: '<S573>/Gain5' */
        rtb_Gain5_d = (real32_T)(kp1 * rtb_Subtract1_j);

        /* Gain: '<S573>/Gain6' */
        rtb_Saturation3_m = (real32_T)(ki1 * rtb_Sum_i);

        /* Gain: '<S573>/Gain7' */
        rtb_Gain_p = (real32_T)(kd1 * rtb_y);

        /* Sum: '<S573>/Add2' */
        rtb_Gain5_d = (rtb_Gain5_d + rtb_Saturation3_m) + rtb_Gain_p;

        /* Memory: '<S573>/Memory13' */
        rtb_Gain_p = six_plus_six_AcmsteeringV09__DW.Memory13_PreviousInput_m;

        /* Sum: '<S573>/Subtract5' */
        rtb_Saturation3_m = rtb_Gain5_d + rtb_Gain_p;
        ...
        if (ESP_switch > 0.5F) {
          ...
          rtb_Gain5_d = rtb_Saturation3_m * (real32_T)rtb_Memory_cn;

          /* Gain: '<S573>/Gain3' */
          rtb_Gain5_d *= 0.125F;
          six_plus_six_AcmsteeringV09_m_B.Switch1 = rtb_Gain5_d;
        } else {
      ...
      /* End of MinMax: '<S569>/MinMax6' */

      /* Lookup_n-D: '<S569>/mot_map4' */
      ...
      /* End of MinMax: '<S569>/MinMax7' */

      /* Lookup_n-D: '<S569>/mot_map1' */
      ...
      /* Sum: '<S569>/Add1' */
      rtb_acc_dem = ((((rtb_acc_dem + rtb_steer_dem) + rtb_brake_dem) +
                      rtb_mot_map5_p) + rtb_Abs) + rtb_mot_map4_k;

      /* Gain: '<S569>/Gain' */
      rtb_acc_dem *= 0.166666672F;

      /* Product: '<S569>/Divide' */
      rtb_Gain1_j = 9549.0 * rtb_y / rtb_acc_dem;
      ...
      rtb_Abs1_f = look1_iflf_binlx(rtb_Abs1_f,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      rtb_Abs10_n = look1_iflf_binlx(rtb_Abs10_n,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      /* End of MinMax: '<S569>/MinMax1' */

      /* Lookup_n-D: '<S569>/mot_map2' */
      rtb_mot_map5_p = look1_iflf_binlx(rtb_mot_map5_p,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      /* End of MinMax: '<S569>/MinMax4' */

      /* Lookup_n-D: '<S569>/mot_map5' */
      rtb_Abs = look1_iflf_binlx(rtb_Abs,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      /* End of MinMax: '<S569>/MinMax8' */

      /* Lookup_n-D: '<S569>/mot_map3' */
      rtb_mot_map4_k = look1_iflf_binlx(rtb_mot_map4_k,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);
      ...
      /* MATLAB Function: '<S568>/MATLAB Function5' incorporates:
       *  Constant: '<S568>/Constant11'
       *  Constant: '<S568>/ECCalVar'
       *  Constant: '<S568>/ECCalVar1'
       *  Constant: '<S568>/ECCalVar2'
       *  Constant: '<S568>/ECCalVar3'
       *  Constant: '<S568>/ECCalVar4'
       *  Constant: '<S568>/ECCalVar5'
       */
      six_plus_si_MATLABFunction5(RC_switch, guzhang_lf, guzhang_lm, guzhang_lr,
        guzhang_rf, guzhang_rm, guzhang_rr,
      ...
      /* MATLAB Function: '<S568>/MATLAB Function' incorporates:
      ...
      /* End of Abs: '<S572>/Abs20' */

      /* MinMax: '<S572>/MinMax' */
      if (!((rtb_Gain5_d <= rtb_mot_map4_k) || rtIsNaNF(rtb_mot_map4_k))) {
        rtb_Gain5_d = rtb_mot_map4_k;
      }

      if (!((rtb_Gain5_d <= rtb_Abs1) || rtIsNaNF(rtb_Abs1))) {
        rtb_Gain5_d = rtb_Abs1;
      }
      ...
      if (!((rtb_Gain5_d <= rtb_mot_map5_p) || rtIsNaNF(rtb_mot_map5_p))) {
        rtb_Gain5_d = rtb_mot_map5_p;
      }

      /* End of MinMax: '<S572>/MinMax' */
      ...
      /* Lookup_n-D: '<S572>/1-D Lookup Table' */
      rtb_DLookupTable = look1_iflf_binlx(rtb_Gain5_d,
        six_plus_six_Acmsteering_ConstP.pooled69,
        six_plus_six_Acmsteering_ConstP.pooled68, 3U);

      /* Outputs for Atomic SubSystem: '<S575>/直行TCS' */
      /* Gain: '<S704>/Gain3' */
      rtb_Add2_c = 0.125F * rtb_Abs3;

      /* Gain: '<S704>/Gain' */
      rtb_Add2_c *= 0.104719758F;

      /* Gain: '<S704>/Gain1' */
      rtb_Add2_c *= 0.2286F;

      /* MinMax: '<S710>/MinMax' */
      if ((rtb_Abs3 <= rtb_Abs14_m) || rtIsNaNF(rtb_Abs14_m)) {
        rtb_Gain5_d = rtb_Abs3;
      } else {
        rtb_Gain5_d = rtb_Abs14_m;
      }
      ...
      /* Sum: '<S704>/Subtract' */
      rtb_steer_dem = rtb_Add2_c - rtb_steer_dem;

      /* Sum: '<S704>/Add' incorporates:
       *  Constant: '<S704>/Constant'
       */
      rtb_Add2_c += 2.22044605E-16F;

      /* Product: '<S704>/Divide' */
      rtb_steer_dem /= rtb_Add2_c;

      /* Saturate: '<S703>/Saturation' */
      ...
      /* End of Saturate: '<S703>/Saturation' */

      /* Gain: '<S705>/Gain3' */
      rtb_steer_dem = 0.125F * rtb_Abs14_m;
      ...
      /* Gain: '<S705>/Gain2' */
      rtb_Add2_c = 0.277777791F * rtb_acc_dem;
      ...
      /* Product: '<S705>/Divide' */
      rtb_Add2_c /= rtb_steer_dem;

      /* Saturate: '<S703>/Saturation1' */
      if (rtb_Add2_c > 2.0F) {
        rtb_Saturation1 = 2.0F;
      } else if (rtb_Add2_c < 0.0F) {
        rtb_Saturation1 = 0.0F;
      } else {
        rtb_Saturation1 = rtb_Add2_c;
      }

      /* End of Saturate: '<S703>/Saturation1' */
      ...
      /* End of Saturate: '<S703>/Saturation2' */
      ...
      /* Saturate: '<S703>/Saturation3' */
      if (rtb_Add2_c > 2.0F) {
        rtb_Saturation3 = 2.0F;
      } else if (rtb_Add2_c < 0.0F) {
        rtb_Saturation3 = 0.0F;
      } else {
        rtb_Saturation3 = rtb_Add2_c;
      }

      /* End of Saturate: '<S703>/Saturation3' */
      ...
      /* Saturate: '<S703>/Saturation4' */
      if (rtb_Add2_c > 2.0F) {
        rtb_Saturation4 = 2.0F;
      } else if (rtb_Add2_c < 0.0F) {
        rtb_Saturation4 = 0.0F;
      } else {
        rtb_Saturation4 = rtb_Add2_c;
      }

      /* End of Saturate: '<S703>/Saturation4' */
      ...
      /* End of Saturate: '<S703>/Saturation5' */

      /* Outputs for Atomic SubSystem: '<S703>/直行' */
      /* Lookup_n-D: '<S712>/1-D Lookup Table' */
      rtb_DLookupTable_g = look1_iflf_binlx
        (six_plus_six_AcmsteeringV09_m_B.steer_dem,
         six_plus_six_Acmsteering_ConstP.pooled41,
         six_plus_six_Acmsteering_ConstP.pooled40, 2U);
      ...
      /* MATLAB Function: '<S712>/MATLAB Function' incorporates:
       *  Constant: '<S712>/Constant7'
       */
      ...
      /* Memory: '<S712>/Memory10' */
      rtb_Memory10 = six_plus_six_AcmsteeringV09__DW.Memory10_PreviousInput;

      /* MATLAB Function: '<S712>/MATLAB Function4' incorporates:
       *  Constant: '<S712>/Constant12'
       */
      ...
      /* MATLAB Function: '<S712>/MATLAB Function1' incorporates:
       *  Constant: '<S712>/Constant8'
       */
      ...
      /* MATLAB Function: '<S712>/MATLAB Function2' incorporates:
       *  Constant: '<S712>/Constant9'
       */
      ...
      /* Memory: '<S712>/Memory11' */
      rtb_Memory11 = six_plus_six_AcmsteeringV09__DW.Memory11_PreviousInput;

      /* MATLAB Function: '<S712>/MATLAB Function6' incorporates:
       *  Constant: '<S712>/Constant13'
       */
      ...
      /* MATLAB Function: '<S712>/MATLAB Function3' incorporates:
       *  Constant: '<S712>/Constant10'
       */
      ...
      /* MATLAB Function: '<S712>/MATLAB Function5' incorporates:
       *  Constant: '<S712>/Constant11'
       */
      /* MATLAB Function 'MainControl/mode_control/backward/backward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function5': '<S724>:1' */
      if (TCS_switch == 0.0F) {
        /* '<S724>:1:3' */
        /* '<S724>:1:4' */
        rtb_brake_dem = 0.0F;
      ...
      /* End of MATLAB Function: '<S712>/MATLAB Function5' */

      /* If: '<S727>/If' */
      rtb_Memory_cn = six_plus_six_AcmsteeringV09__DW.If_ActiveSubsystem;
      rtAction = -1;
      if (rtb_brake_dem > 0.5F) {
        rtAction = 0;
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S727>/Subsystem' incorporates:
           *  InitializeConditions for ActionPort: '<S728>/Action Port'
           */
          /* InitializeConditions for If: '<S727>/If' incorporates:
           *  InitializeConditions for Memory: '<S728>/Memory13'
           *  InitializeConditions for Memory: '<S728>/Memory3'
           *  InitializeConditions for Memory: '<S728>/Memory4'
           *  InitializeConditions for Memory: '<S728>/Memory5'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S727>/Subsystem' */
        }

        /* Outputs for IfAction SubSystem: '<S727>/Subsystem' incorporates:
        ...
        /* Memory: '<S728>/Memory4' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_bb;

        /* Gain: '<S728>/Gain20' */
        rtb_acc_dem = 2.0F * rtb_Add2_c;

        /* Memory: '<S728>/Memory5' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_h;

        /* Sum: '<S728>/Add10' */
        rtb_acc_dem = (rtb_steer_dem - rtb_acc_dem) + rtb_Gain5_d;

        /* Memory: '<S728>/Memory3' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_n;
        ...
        /* Gain: '<S728>/Gain' */
        rtb_Gain5_d = 0.125F * rtb_acc_dem;
        ...
        /* DataTypeConversion: '<S728>/Data Type Conversion' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_f = rtb_Gain5_d;

        /* Update for Memory: '<S728>/Memory4' */
        six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_bb = rtb_steer_dem;

        /* Update for Memory: '<S728>/Memory5' */
        six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_h = rtb_Add2_c;

        /* Update for Memory: '<S728>/Memory3' */
        six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_n = rtb_steer_dem;

        /* Update for Memory: '<S728>/Memory13' */
        six_plus_six_AcmsteeringV09__DW.Memory13_PreviousInput_j = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S727>/Subsystem' */
      }
      ...
      /* Switch: '<S727>/Switch' */
      if (rtb_brake_dem > 0.5F) {
        rtb_Abs7_j = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_f;
      } else {
        rtb_Abs7_j =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_c0.trq_dem_lf;
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S727>/Subsystem4' incorporates:
           *  InitializeConditions for ActionPort: '<S732>/Action Port'
           */
          /* InitializeConditions for If: '<S727>/If4' incorporates:
           *  InitializeConditions for Memory: '<S732>/Memory13'
           *  InitializeConditions for Memory: '<S732>/Memory3'
           *  InitializeConditions for Memory: '<S732>/Memory4'
           *  InitializeConditions for Memory: '<S732>/Memory5'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S727>/Subsystem4' */
        }

        /* Outputs for IfAction SubSystem: '<S727>/Subsystem4' incorporates:
        ...
        /* Memory: '<S732>/Memory4' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_k;

        /* Gain: '<S732>/Gain20' */
        rtb_acc_dem = 2.0F * rtb_Add2_c;

        /* Memory: '<S732>/Memory5' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_p;

        /* Sum: '<S732>/Add10' */
        rtb_acc_dem = (rtb_steer_dem - rtb_acc_dem) + rtb_Gain5_d;

        /* Memory: '<S732>/Memory3' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_a;
        ...
        /* DataTypeConversion: '<S732>/Data Type Conversion' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion = rtb_Gain5_d;

        /* Update for Memory: '<S732>/Memory4' */
        six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_k = rtb_steer_dem;

        /* Update for Memory: '<S732>/Memory5' */
        six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_p = rtb_Add2_c;

        /* Update for Memory: '<S732>/Memory3' */
        six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_a = rtb_steer_dem;

        /* Update for Memory: '<S732>/Memory13' */
        six_plus_six_AcmsteeringV09__DW.Memory13_PreviousInput = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S727>/Subsystem4' */
      }
      ...
      /* Switch: '<S727>/Switch4' */
      if (rtb_Gain_p > 0.5F) {
        rtb_Abs14_m = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion;
      } else {
        rtb_Abs14_m =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_c0.trq_dem_lm;
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S727>/Subsystem1' incorporates:
           *  InitializeConditions for ActionPort: '<S729>/Action Port'
           */
          /* InitializeConditions for If: '<S727>/If1' incorporates:
          ...
          /* End of InitializeConditions for SubSystem: '<S727>/Subsystem1' */
        }

        /* Outputs for IfAction SubSystem: '<S727>/Subsystem1' incorporates:
        ...
        /* Memory: '<S729>/Memory4' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory4_PreviousInput_h;

        /* Gain: '<S729>/Gain20' */
        rtb_acc_dem = 2.0F * rtb_Add2_c;

        /* Memory: '<S729>/Memory5' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_f;

        /* Sum: '<S729>/Add10' */
        rtb_acc_dem = (rtb_steer_dem - rtb_acc_dem) + rtb_Gain5_d;

        /* Memory: '<S729>/Memory3' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_f3;
        ...
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_g = rtb_Gain5_d;
        ...
        six_plus_six_AcmsteeringV09__DW.Memory5_PreviousInput_f = rtb_Add2_c;
        ...
        /* End of Outputs for SubSystem: '<S727>/Subsystem1' */
      }
      ...
      /* Switch: '<S727>/Switch1' */
      if (rtb_Abs1_f > 0.5F) {
        rtb_Abs3 = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion_g;
      } else {
        rtb_Abs3 =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_c0.trq_dem_lr;
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S727>/Subsystem2' incorporates:
           *  InitializeConditions for ActionPort: '<S730>/Action Port'
           */
          /* InitializeConditions for If: '<S727>/If2' incorporates:
           *  InitializeConditions for Memory: '<S730>/Memory1'
           *  InitializeConditions for Memory: '<S730>/Memory15'
           *  InitializeConditions for Memory: '<S730>/Memory2'
           *  InitializeConditions for Memory: '<S730>/Memory6'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S727>/Subsystem2' */
        }

        /* Outputs for IfAction SubSystem: '<S727>/Subsystem2' incorporates:
         *  ActionPort: '<S730>/Action Port'
         */
        /* Sum: '<S730>/Sum3' */
        rtb_Add2_c = rtb_DLookupTable - rtb_Saturation3;
        ...
        /* Memory: '<S730>/Memory2' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_m;
        ...
        /* Memory: '<S730>/Memory6' */
        rtb_Saturation3_m =
          six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_p3;
        ...
        /* Memory: '<S730>/Memory15' */
        rtb_Saturation3_m =
          six_plus_six_AcmsteeringV09__DW.Memory15_PreviousInput_c;
        ...
        /* Update for Memory: '<S730>/Memory1' */
        six_plus_six_AcmsteeringV09__DW.Memory1_PreviousInput_i = rtb_Add2_c;

        /* Update for Memory: '<S730>/Memory2' */
        six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_m = rtb_Add2_c;

        /* Update for Memory: '<S730>/Memory6' */
        six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_p3 = rtb_Gain5_d;

        /* Update for Memory: '<S730>/Memory15' */
        six_plus_six_AcmsteeringV09__DW.Memory15_PreviousInput_c = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S727>/Subsystem2' */
      }
      ...
      /* Switch: '<S727>/Switch3' */
      if (rtb_Abs10_n > 0.5F) {
        rtb_Abs6_i = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion2_a;
      } else {
        rtb_Abs6_i =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_c0.trq_dem_rf;
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S727>/Subsystem5' incorporates:
           *  InitializeConditions for ActionPort: '<S733>/Action Port'
           */
          /* InitializeConditions for If: '<S727>/If5' incorporates:
           *  InitializeConditions for Memory: '<S733>/Memory1'
           *  InitializeConditions for Memory: '<S733>/Memory15'
           *  InitializeConditions for Memory: '<S733>/Memory2'
           *  InitializeConditions for Memory: '<S733>/Memory6'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S727>/Subsystem5' */
        }

        /* Outputs for IfAction SubSystem: '<S727>/Subsystem5' incorporates:
         *  ActionPort: '<S733>/Action Port'
         */
        /* Sum: '<S733>/Sum3' */
        rtb_Add2_c = rtb_DLookupTable - rtb_Saturation4;
        ...
        /* Memory: '<S733>/Memory2' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_n;
        ...
        /* Memory: '<S733>/Memory6' */
        rtb_Saturation3_m =
          six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_i;
        ...
        /* Memory: '<S733>/Memory15' */
        rtb_Saturation3_m =
          six_plus_six_AcmsteeringV09__DW.Memory15_PreviousInput;
        ...
        /* DataTypeConversion: '<S733>/Data Type Conversion2' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion2 = rtb_Saturation3_m;

        /* Update for Memory: '<S733>/Memory1' */
        six_plus_six_AcmsteeringV09__DW.Memory1_PreviousInput_c = rtb_Add2_c;

        /* Update for Memory: '<S733>/Memory2' */
        six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_n = rtb_Add2_c;

        /* Update for Memory: '<S733>/Memory6' */
        six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_i = rtb_Gain5_d;

        /* Update for Memory: '<S733>/Memory15' */
        six_plus_six_AcmsteeringV09__DW.Memory15_PreviousInput = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S727>/Subsystem5' */
      }
      ...
      /* Switch: '<S727>/Switch5' */
      if (rtb_mot_map_a > 0.5F) {
        rtb_Saturation3_m = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion2;
      } else {
        rtb_Saturation3_m =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_c0.trq_dem_rm;
      }

      /* End of Switch: '<S727>/Switch5' */

      /* If: '<S727>/If3' */
      rtb_Memory_cn = six_plus_six_AcmsteeringV09__DW.If3_ActiveSubsystem;
      rtAction = -1;
      if (rtb_mot_map1_j > 0.5F) {
        rtAction = 0;
      }
      ...
      if (rtAction == 0) {
        if (0 != rtb_Memory_cn) {
          /* InitializeConditions for IfAction SubSystem: '<S727>/Subsystem3' incorporates:
           *  InitializeConditions for ActionPort: '<S731>/Action Port'
           */
          /* InitializeConditions for If: '<S727>/If3' incorporates:
           *  InitializeConditions for Memory: '<S731>/Memory16'
           *  InitializeConditions for Memory: '<S731>/Memory7'
           *  InitializeConditions for Memory: '<S731>/Memory8'
           *  InitializeConditions for Memory: '<S731>/Memory9'
           */
          ...
          /* End of InitializeConditions for SubSystem: '<S727>/Subsystem3' */
        }

        /* Outputs for IfAction SubSystem: '<S727>/Subsystem3' incorporates:
        ...
        /* Memory: '<S731>/Memory8' */
        rtb_Add2_c = six_plus_six_AcmsteeringV09__DW.Memory8_PreviousInput;

        /* Gain: '<S731>/Gain23' */
        rtb_acc_dem = 2.0F * rtb_Add2_c;

        /* Memory: '<S731>/Memory9' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory9_PreviousInput;

        /* Sum: '<S731>/Add12' */
        rtb_acc_dem = (rtb_steer_dem - rtb_acc_dem) + rtb_Gain5_d;

        /* Memory: '<S731>/Memory7' */
        rtb_Gain5_d = six_plus_six_AcmsteeringV09__DW.Memory7_PreviousInput;
        ...
        /* DataTypeConversion: '<S731>/Data Type Conversion3' */
        six_plus_six_AcmsteeringV09_m_B.DataTypeConversion3 = rtb_Gain5_d;

        /* Update for Memory: '<S731>/Memory8' */
        six_plus_six_AcmsteeringV09__DW.Memory8_PreviousInput = rtb_steer_dem;

        /* Update for Memory: '<S731>/Memory9' */
        six_plus_six_AcmsteeringV09__DW.Memory9_PreviousInput = rtb_Add2_c;

        /* Update for Memory: '<S731>/Memory7' */
        six_plus_six_AcmsteeringV09__DW.Memory7_PreviousInput = rtb_steer_dem;

        /* Update for Memory: '<S731>/Memory16' */
        six_plus_six_AcmsteeringV09__DW.Memory16_PreviousInput = rtb_acc_dem;

        /* End of Outputs for SubSystem: '<S727>/Subsystem3' */
      }
      ...
      /* Switch: '<S727>/Switch2' */
      if (rtb_mot_map1_j > 0.5F) {
        rtb_Gain5_d = six_plus_six_AcmsteeringV09_m_B.DataTypeConversion3;
      } else {
        rtb_Gain5_d =
          six_plus_six_AcmsteeringV09_m_B.sf_MATLABFunction_c0.trq_dem_rr;
      }
      ...
      /* MATLAB Function: '<S712>/MATLAB Function7' */
      /* MATLAB Function 'MainControl/mode_control/backward/backward/Drive/驱动防滑控制TCS/直行TCS/直行/MATLAB Function7': '<S726>:1' */
      if ((rtb_brake_dem == 0.0F) && (rtb_Gain_p == 0.0F) && (rtb_Abs1_f == 0.0F)
          && (rtb_Abs10_n == 0.0F) && (rtb_mot_map_a == 0.0F) && (rtb_mot_map1_j
           == 0.0F)) {
        /* '<S726>:1:3' */
        /*  0电机滑转===============================================0电机滑转 */
        /* '<S726>:1:4' */
        ...
        /* '<S726>:1:11' */
        /* '<S726>:1:12' */
      } else if ((rtb_brake_dem == 1.0F) && (rtb_Gain_p == 0.0F) && (rtb_Abs1_f ==
                  0.0F) && (rtb_Abs10_n == 0.0F) && (rtb_mot_map_a == 0.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:22' */
        /* 左前轮滑转===================================================1电机滑转 */
        /* '<S726>:1:23' */
        ...
        /* '<S726>:1:30' */
        /* '<S726>:1:31' */
      } else if ((rtb_brake_dem == 0.0F) && (rtb_Gain_p == 1.0F) && (rtb_Abs1_f ==
                  0.0F) && (rtb_Abs10_n == 0.0F) && (rtb_mot_map_a == 0.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:32' */
        /* 左中轮滑转 */
        ...
        /* '<S726>:1:40' */
        /* '<S726>:1:41' */
      } else if ((rtb_brake_dem == 0.0F) && (rtb_Gain_p == 0.0F) && (rtb_Abs1_f ==
                  1.0F) && (rtb_Abs10_n == 0.0F) && (rtb_mot_map_a == 0.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:42' */
        /* 左后轮滑转 */
        /* '<S726>:1:43' */
        ...
        /* '<S726>:1:51' */
                  ...
                  0.0F) && (rtb_Abs10_n == 1.0F) && (rtb_mot_map_a == 0.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:53' */
        /* 右前轮滑转 */
        /* '<S726>:1:54' */
        ...
        /* '<S726>:1:62' */
                  ...
                  0.0F) && (rtb_Abs10_n == 0.0F) && (rtb_mot_map_a == 1.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:63' */
        /* 右中轮滑转 */
        /* '<S726>:1:64' */
        ...
        /* '<S726>:1:81' */
        /* '<S726>:1:82' */
      } else if ((rtb_brake_dem == 1.0F) && (rtb_Gain_p == 1.0F) && (rtb_Abs1_f ==
                  0.0F) && (rtb_Abs10_n == 0.0F) && (rtb_mot_map_a == 0.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:93' */
        /* 左前-左中 轮滑转===================================================2电机滑转    左侧 */
        ...
        /* '<S726>:1:122' */
                  ...
                  0.0F) && (rtb_Abs10_n == 1.0F) && (rtb_mot_map_a == 1.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:124' */
        /* 右前-右中 轮滑转                        右侧 */
        /* '<S726>:1:125' */
        ...
        /* '<S726>:1:215' */
                  ...
                  1.0F) && (rtb_Abs10_n == 1.0F) && (rtb_mot_map_a == 0.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:216' */
        /* 左后-右前 轮滑转                 对侧 */
        /* '<S726>:1:217' */
        ...
        /* '<S726>:1:225' */
                  ...
                  1.0F) && (rtb_Abs10_n == 0.0F) && (rtb_mot_map_a == 1.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:226' */
        /* 左后-右中 轮滑转 */
        /* '<S726>:1:227' */
        ...
        /* '<S726>:1:401' */
                  ...
                  1.0F) && (rtb_Abs10_n == 1.0F) && (rtb_mot_map_a == 1.0F) &&
                 (rtb_mot_map1_j == 0.0F)) {
        /* '<S726>:1:402' */
        /* 右前-右中-左后 轮滑转 */
        /* '<S726>:1:403' */
        ...
        if (rtb_acc_dem >= 0.0F) {
          /* '<S726>:1:748' */
          /* '<S726>:1:749' */
          rtb_Abs6_i -= rtb_acc_dem / 3.0F;

          /* '<S726>:1:750' */
          rtb_Saturation3_m -= rtb_acc_dem / 3.0F;

          /* '<S726>:1:751' */
          rtb_Gain5_d -= rtb_acc_dem / 3.0F;
        } else {
          /* '<S726>:1:753' */
          rtb_Abs7_j += rtb_acc_dem / 3.0F;

          /* '<S726>:1:754' */
          rtb_Abs14_m += rtb_acc_dem / 3.0F;

          /* '<S726>:1:755' */
          rtb_Abs3 += rtb_acc_dem / 3.0F;
        }
      ...
      /* End of MATLAB Function: '<S712>/MATLAB Function7' */

      /* Saturate: '<S712>/Saturation4' */
      /* '<S726>:1:764' */
      /* '<S726>:1:765' */
      /* '<S726>:1:766' */
      /* '<S726>:1:767' */
      ...
      /* End of Saturate: '<S712>/Saturation4' */

      /* Lookup_n-D: '<S712>/1-D Lookup Table1' */
      rtb_steer_dem = look1_iflf_binlx(rtb_steer_dem,
        six_plus_six_Acmsteering_ConstP.pooled46,
        six_plus_six_Acmsteering_ConstP.pooled45, 1U);

      /* Gain: '<S712>/Gain' */
      rtb_Add2_c = 0.5F * rtb_DLookupTable_g;
      ...
      /* MATLAB Function: '<S712>/HeartBeat' */
      ...
      /* MATLAB Function: '<S712>/HeartBeat1' */
      ...
      /* MATLAB Function: '<S712>/HeartBeat2' */
      ...
      /* MATLAB Function: '<S712>/HeartBeat3' */
      ...
      /* MATLAB Function: '<S712>/HeartBeat4' */
      ...
      /* MATLAB Function: '<S712>/HeartBeat5' */
      six_plus_six_Acms_HeartBeat(rtb_Memory6_l,
        &six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat5_j);

      /* Saturate: '<S712>/Saturation10' */
      if (rtb_acc_dem > 400000.0F) {
        rtb_Abs1 = 400000.0F;
      } else if (rtb_acc_dem < -400000.0F) {
        rtb_Abs1 = -400000.0F;
      } else {
        rtb_Abs1 = rtb_acc_dem;
      }

      /* End of Saturate: '<S712>/Saturation10' */

      /* Saturate: '<S712>/Saturation11' */
      if (rtb_steer_dem > 750000.0F) {
        rtb_Abs = 750000.0F;
      } else if (rtb_steer_dem < -140000.0F) {
        rtb_Abs = -140000.0F;
      } else {
        rtb_Abs = rtb_steer_dem;
      }

      /* End of Saturate: '<S712>/Saturation11' */

      /* Saturate: '<S712>/Saturation8' */
      if (rtb_DLookupTable_g > 400000.0F) {
        rtb_DLookupTable_g = 400000.0F;
      } else {
        if (rtb_DLookupTable_g < -400000.0F) {
      ...
      /* End of Saturate: '<S712>/Saturation8' */

      /* Saturate: '<S712>/Saturation9' */
      if (rtb_Add2_c > 400000.0F) {
        rtb_mot_map4_k = 400000.0F;
      } else if (rtb_Add2_c < -400000.0F) {
        rtb_mot_map4_k = -400000.0F;
      } else {
        rtb_mot_map4_k = rtb_Add2_c;
      }

      /* End of Saturate: '<S712>/Saturation9' */
       ...
       *  Constant: '<S712>/Constant5'
       *  Constant: '<S712>/Constant6'
       *  Constant: '<S712>/SpdSet_dem'
       *  Constant: '<S712>/SpdSet_dem1'
       *  Constant: '<S712>/SpdSet_dem2'
       *  Constant: '<S712>/SpdSet_dem3'
       *  Constant: '<S712>/SpdSet_dem4'
       *  Constant: '<S712>/SpdSet_dem5'
       *  Constant: '<S712>/mot_mode'
       *  Constant: '<S712>/mot_mode1'
       *  Constant: '<S712>/mot_mode10'
       *  Constant: '<S712>/mot_mode11'
       *  Constant: '<S712>/mot_mode2'
       *  Constant: '<S712>/mot_mode3'
       *  Constant: '<S712>/mot_mode4'
       *  Constant: '<S712>/mot_mode5'
       *  Constant: '<S712>/mot_mode6'
       *  Constant: '<S712>/mot_mode7'
       *  Constant: '<S712>/mot_mode8'
       *  Constant: '<S712>/mot_mode9'
       *  Switch: '<S712>/Switch1'
       *  Switch: '<S712>/Switch10'
       *  Switch: '<S712>/Switch11'
       *  Switch: '<S712>/Switch12'
       *  Switch: '<S712>/Switch13'
       *  Switch: '<S712>/Switch14'
       *  Switch: '<S712>/Switch15'
       *  Switch: '<S712>/Switch16'
       *  Switch: '<S712>/Switch17'
       *  Switch: '<S712>/Switch2'
       *  Switch: '<S712>/Switch3'
       *  Switch: '<S712>/Switch4'
       *  Switch: '<S712>/Switch5'
      ...
      if (Compare_i) {
        ...
        /* Abs: '<S712>/Abs' incorporates:
         *  Constant: '<S712>/mot_mode6'
         */
        rtb_acc_dem = (real32_T)fabs(acc_dem);

        /* Lookup_n-D: '<S712>/1-D Lookup Table2' */
        brake_dem = look1_iflf_binlx(rtb_acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);
        ...
        /* Lookup_n-D: '<S712>/1-D Lookup Table4' */
        rtb_Abs8_m = look1_iflf_binlx(rtb_acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);
        ...
        /* Lookup_n-D: '<S712>/1-D Lookup Table5' */
        rtb_Abs9_p = look1_iflf_binlx(rtb_acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);
        ...
        /* Lookup_n-D: '<S712>/1-D Lookup Table6' */
        rtb_DLookupTable6_p = look1_iflf_binlx(rtb_acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);
        ...
        /* Lookup_n-D: '<S712>/1-D Lookup Table7' */
        rtb_DLookupTable7_e = look1_iflf_binlx(rtb_acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);
        rtb_mot_map1_j = 0.0F;
        rtb_mot_map_a = 0.0F;
        ...
        /* Lookup_n-D: '<S712>/1-D Lookup Table3' */
        rtb_DLookupTable3_e = look1_iflf_binlx(rtb_acc_dem,
          six_plus_six_Acmsteering_ConstP.pooled46,
          six_plus_six_Acmsteering_ConstP.pooled59, 1U);
        rtb_acc_dem = 0.0F;
      } else {
        ...
        /* Saturate: '<S712>/Saturation6' incorporates:
         *  Constant: '<S712>/SpdSet_dem'
         *  Constant: '<S712>/SpdSet_dem2'
         *  Constant: '<S712>/SpdSet_dem3'
         *  Constant: '<S712>/SpdSet_dem4'
        ...
        if (rtb_Abs14_m > 70.5F) {
          rtb_mot_map1_j = 70.5F;
        } else if (rtb_Abs14_m < -70.5F) {
          rtb_mot_map1_j = -70.5F;
        } else {
          rtb_mot_map1_j = rtb_Abs14_m;
        }

        /* End of Saturate: '<S712>/Saturation6' */

        /* Saturate: '<S712>/Saturation7' */
        if (rtb_Saturation3_m > 70.5F) {
          rtb_mot_map_a = 70.5F;
        } else if (rtb_Saturation3_m < -70.5F) {
          rtb_mot_map_a = -70.5F;
        } else {
          rtb_mot_map_a = rtb_Saturation3_m;
        }

        /* End of Saturate: '<S712>/Saturation7' */

        /* Saturate: '<S712>/Saturation1' */
        if (rtb_Abs3 > 70.5F) {
          rtb_Abs10_n = 70.5F;
        } else if (rtb_Abs3 < -70.5F) {
          rtb_Abs10_n = -70.5F;
        } else {
          rtb_Abs10_n = rtb_Abs3;
        }

        /* End of Saturate: '<S712>/Saturation1' */

        /* Saturate: '<S712>/Saturation3' */
        if (rtb_Gain5_d > 70.5F) {
          rtb_Abs1_f = 70.5F;
        } else if (rtb_Gain5_d < -70.5F) {
          rtb_Abs1_f = -70.5F;
        } else {
          rtb_Abs1_f = rtb_Gain5_d;
        }

        /* End of Saturate: '<S712>/Saturation3' */

        /* Saturate: '<S712>/Saturation' */
        if (rtb_Abs7_j > 70.5F) {
          rtb_steer_dem = 70.5F;
        } else if (rtb_Abs7_j < -70.5F) {
          rtb_steer_dem = -70.5F;
        } else {
          rtb_steer_dem = rtb_Abs7_j;
        }
        ...
        /* Saturate: '<S712>/Saturation2' incorporates:
         *  Constant: '<S712>/SpdSet_dem1'
         *  Constant: '<S712>/mot_mode1'
         *  Constant: '<S712>/mot_mode2'
         *  Constant: '<S712>/mot_mode3'
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[7] =
        rtb_Gain5_d;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[8] = 2.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[9] =
        rtb_Abs8_m;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[13] =
        rtb_brake_dem;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[14] = 2.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[15] =
        rtb_DLookupTable6_p;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[19] =
        rtb_Add2_c;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[20] = 1.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[21] =
        rtb_DLookupTable3_e;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[25] =
        rtb_Saturation3_m;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[26] = 1.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[27] =
        rtb_Abs9_p;
      ...
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[31] =
        rtb_Gain_p;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[32] = 1.0F;
      six_plus_six_AcmsteeringV09_m_B.OutportBufferForbackward_dem_e[33] =
        rtb_DLookupTable7_e;
      ...
      /* Outputs for Atomic SubSystem: '<S424>/目标转向力矩确定模块' */
      six_plus_six_AcmsteeringV_u(rtb_Abs15_i, rtb_Abs16_h, rtb_Abs17_d,
        rtb_Abs18_j, rtb_Abs21, rtb_Abs22);

      /* End of Outputs for SubSystem: '<S424>/目标转向力矩确定模块' */

      /* End of Outputs for SubSystem: '<S422>/Drive' */
      break;

     case 1:
      /* Outputs for IfAction SubSystem: '<S422>/Brake' incorporates:
       *  ActionPort: '<S423>/Action Port'
       */
      /* Lookup_n-D: '<S423>/1-D Lookup Table1' */
      rtb_Abs10_n = look1_iflf_binlx(six_plus_six_AcmsteeringV09_m_B.steer_dem,
        six_plus_six_Acmsteering_ConstP.pooled41,
        six_plus_six_Acmsteering_ConstP.pooled40, 2U);

      /* Lookup_n-D: '<S423>/1-D Lookup Table2' */
      rtb_mot_map_a = look1_iflf_binlx(brake_dem,
        six_plus_six_Acmsteering_ConstP.pooled46,
        six_plus_six_Acmsteering_ConstP.pooled45, 1U);
      ...
      /* MATLAB Function: '<S423>/HeartBeat' */
      ...
      /* MATLAB Function: '<S423>/HeartBeat1' */
      ...
      /* MATLAB Function: '<S423>/HeartBeat2' */
      ...
      /* MATLAB Function: '<S423>/HeartBeat3' */
      ...
      /* MATLAB Function: '<S423>/HeartBeat4' */
      ...
      /* End of Saturate: '<S423>/Saturation8' */

      /* Saturate: '<S423>/Saturation9' */
      if (rtb_acc_dem > 400000.0F) {
        rtb_acc_dem = 400000.0F;
      } else {
        if (rtb_acc_dem < -400000.0F) {
      ...
      /* End of Saturate: '<S423>/Saturation9' */

      /* Saturate: '<S423>/Saturation10' */
      if (rtb_steer_dem > 400000.0F) {
        rtb_steer_dem = 400000.0F;
      } else {
        if (rtb_steer_dem < -400000.0F) {
      ...
      /* End of Saturate: '<S423>/Saturation10' */

      /* Saturate: '<S423>/Saturation11' */
      if (rtb_mot_map_a > 750000.0F) {
        rtb_mot_map_a = 750000.0F;
      } else {
        if (rtb_mot_map_a < -140000.0F) {
      ...
      /* End of Saturate: '<S423>/Saturation11' */

      /* SignalConversion: '<S423>/OutportBufferForbackward_dem' incorporates:
       *  Constant: '<S423>/SpdSet_dem'
       *  Constant: '<S423>/SpdSet_dem1'
       *  Constant: '<S423>/SpdSet_dem2'
       *  Constant: '<S423>/SpdSet_dem3'
       *  Constant: '<S423>/SpdSet_dem4'
       *  Constant: '<S423>/SpdSet_dem5'
       *  Constant: '<S423>/mot_enable1'
       *  Constant: '<S423>/mot_enable2'
       *  Constant: '<S423>/mot_enable3'
       *  Constant: '<S423>/mot_enable4'
       *  Constant: '<S423>/mot_enable5'
       *  Constant: '<S423>/mot_enable6'
       *  Constant: '<S423>/mot_gear'
       *  Constant: '<S423>/mot_gear1'
       *  Constant: '<S423>/mot_gear2'
       *  Constant: '<S423>/mot_gear3'
       *  Constant: '<S423>/mot_gear4'
       *  Constant: '<S423>/mot_gear5'
       *  Constant: '<S423>/mot_mode'
       *  Constant: '<S423>/mot_mode1'
       *  Constant: '<S423>/mot_mode2'
       *  Constant: '<S423>/mot_mode3'
       *  Constant: '<S423>/mot_mode4'
       *  Constant: '<S423>/mot_mode5'
       */
      ...
      rtb_LogicalOperator_g = (rtb_Compare || rtb_Compare_ak || rtb_Compare_f3 ||
        rtb_Compare_c || rtb_Compare_nr || rtb_Compare_ag || rtb_Compare_op ||
        rtb_Compare_kx || rtb_Compare_gq || rtb_Compare_iu || Compare ||
        Compare_g || Compare_p || Compare_i || rtb_Compare_n5 || rtb_Compare_b2y
        || rtb_Compare_atf || rtb_Compare_l3 || rtb_Compare_ix || rtb_Compare_dc);

      /* Lookup_n-D: '<S433>/mot_map' */
      rtb_mot_map = look1_iflf_binlx(rtb_Abs14,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S433>/mot_map4' */
      rtb_mot_map4 = look1_iflf_binlx(rtb_Abs15,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S433>/mot_map1' */
      rtb_mot_map1 = look1_iflf_binlx(rtb_Abs16,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S433>/mot_map2' */
      rtb_mot_map2 = look1_iflf_binlx(rtb_Abs17,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S433>/mot_map5' */
      rtb_mot_map5 = look1_iflf_binlx(rtb_Abs18,
        six_plus_six_Acmsteering_ConstP.pooled75,
        six_plus_six_Acmsteering_ConstP.pooled74, 11U);

      /* Lookup_n-D: '<S433>/mot_map3' */
      ...
      rtb_LogicalOperator_a = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
      ...
      rtb_LogicalOperator_n = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
      ...
      rtb_LogicalOperator_p5 = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
      ...
      rtb_LogicalOperator_ag = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
      ...
      rtb_LogicalOperator_f = (rtb_Compare_iu || rtb_Compare_gq ||
        rtb_Compare_b2y || rtb_Compare_n5 || Compare_i || Compare_p || Compare_g
        || Compare || rtb_Compare_ak || rtb_Compare || rtb_Compare_kx ||
        rtb_Compare_op || rtb_Compare_ag || rtb_Compare_nr || rtb_Compare_c ||
        rtb_Compare_f3 || rtb_Compare_dc || rtb_Compare_ix || rtb_Compare_l3 ||
    ...
    /* End of Outputs for SubSystem: '<S407>/backward' */
    break;

   case 4:
    /* Outputs for IfAction SubSystem: '<S407>/center_steer' incorporates:
     *  ActionPort: '<S411>/Action Port'
     */
    /* Switch: '<S734>/Switch' incorporates:
     *  Constant: '<S734>/mot_gear'
     *  Constant: '<S734>/mot_gear1'
     */
    ...
    /* Abs: '<S748>/Abs' */
    rtb_mot_map1_j = (real32_T)fabs(six_plus_six_AcmsteeringV09_m_B.steer_dem);

    /* Gain: '<S748>/Gain2' */
    rtb_mot_map1_j *= 0.01F;
    ...
    /* End of Abs: '<S734>/Abs5' */

    /* Sum: '<S748>/Add1' */
    rtb_Abs1 = ((((rtb_brake_dem + rtb_Gain_p) + rtb_Abs10_n) + rtb_mot_map5_p)
                + rtb_Abs14_m) + rtb_Abs;

    /* Gain: '<S748>/Gain' */
    rtb_Abs1 *= 0.166666672F;

    /* Product: '<S748>/Divide' */
    rtb_y = 9549.0 * rtb_Sum_i / rtb_Abs1;

    /* Lookup_n-D: '<S748>/mot_map' */
    rtb_brake_dem = look1_iflf_binlx(rtb_brake_dem,
      six_plus_six_Acmsteering_ConstP.pooled75,
      six_plus_six_Acmsteering_ConstP.pooled74, 11U);
    ...
    rtb_mot_map4_k = (real32_T)rtb_Sum_i;

    /* End of MinMax: '<S748>/MinMax6' */

    /* Lookup_n-D: '<S748>/mot_map4' */
    rtb_Gain_p = look1_iflf_binlx(rtb_Gain_p,
      six_plus_six_Acmsteering_ConstP.pooled75,
      six_plus_six_Acmsteering_ConstP.pooled74, 11U);
    ...
    rtb_mot_map_a = (real32_T)rtb_Sum_i;

    /* End of MinMax: '<S748>/MinMax1' */

    /* Lookup_n-D: '<S748>/mot_map1' */
    rtb_Abs10_n = look1_iflf_binlx(rtb_Abs10_n,
      six_plus_six_Acmsteering_ConstP.pooled75,
      six_plus_six_Acmsteering_ConstP.pooled74, 11U);
    ...
    rtb_Gain_p = (real32_T)rtb_Sum_i;

    /* End of MinMax: '<S748>/MinMax5' */

    /* Lookup_n-D: '<S748>/mot_map2' */
    rtb_mot_map5_p = look1_iflf_binlx(rtb_mot_map5_p,
      six_plus_six_Acmsteering_ConstP.pooled75,
      six_plus_six_Acmsteering_ConstP.pooled74, 11U);
    ...
    rtb_Saturation3_m = (real32_T)rtb_Sum_i;

    /* End of MinMax: '<S748>/MinMax4' */

    /* Lookup_n-D: '<S748>/mot_map5' */
    rtb_Abs14_m = look1_iflf_binlx(rtb_Abs14_m,
      six_plus_six_Acmsteering_ConstP.pooled75,
      six_plus_six_Acmsteering_ConstP.pooled74, 11U);
    ...
    rtb_Add2_c = (real32_T)rtb_Sum_i;

    /* End of MinMax: '<S748>/MinMax2' */

    /* Lookup_n-D: '<S748>/mot_map3' */
    rtb_Abs = look1_iflf_binlx(rtb_Abs, six_plus_six_Acmsteering_ConstP.pooled75,
      six_plus_six_Acmsteering_ConstP.pooled74, 11U);
    ...
    rtb_Gain5_d = (real32_T)rtb_Sum_i;

    /* End of MinMax: '<S748>/MinMax3' */

    /* Sum: '<S748>/Add3' */
    rtb_Abs1 = ((((rtb_mot_map4_k + rtb_mot_map_a) + rtb_Gain_p) +
                 rtb_Saturation3_m) + rtb_Add2_c) + rtb_Gain5_d;
    ...
    /* End of MinMax: '<S748>/MinMax' */

    /* Product: '<S748>/Product' */
    rtb_y = rtb_mot_map1_j * rtb_Sum_i;

    /* Gain: '<S748>/Gain1' */
    rtb_steer_dem = (real32_T)(0.5 * rtb_y);

    /* Gain: '<S734>/Gain5' */
    rtb_Abs1 = 0.01F * brake_dem;
    ...
    /* Gain: '<S734>/Gain6' */
    rtb_Abs = 0.5F * rtb_Abs1;

    /* Lookup_n-D: '<S734>/1-D Lookup Table3' */
    look1_iflf_binlx(rtb_Abs, six_plus_six_Acmsteering_ConstP.pooled77,
                     six_plus_six_Acmsteering_ConstP.pooled76, 10U);

    /* Gain: '<S734>/Gain7' */
    rtb_Abs1 *= 0.5F;

    /* Lookup_n-D: '<S734>/1-D Lookup Table1' */
    look1_iflf_binlx(rtb_Abs1, six_plus_six_Acmsteering_ConstP.pooled77,
                     six_plus_six_Acmsteering_ConstP.pooled76, 10U);

    /* MATLAB Function: '<S747>/MATLAB Function' */
    /* MATLAB Function 'MainControl/mode_control/center_steer/center_steer/容错控制/MATLAB Function': '<S869>:1' */
    if (brake_dem == 0.0F) {
      /* '<S869>:1:3' */
      /* '<S869>:1:5' */
      ...
      /* '<S869>:1:6' */
      rtb_Abs1_f = rtb_steer_dem / 3.0F;

      /* '<S869>:1:7' */
      rtb_brake_dem = rtb_steer_dem / 3.0F;

      /* '<S869>:1:8' */
      rtb_mot_map1_j = rtb_steer_dem / 3.0F;

      /* '<S869>:1:9' */
      rtb_DLookupTable_g = rtb_steer_dem / 3.0F;
    ...
    /* '<S869>:1:157' */
    if ((rtb_mot_map4_k <= rtb_acc_dem) || rtIsNaNF(rtb_acc_dem)) {
      rtb_acc_dem = rtb_mot_map4_k;
    }
    ...
    /* '<S869>:1:158' */
    if ((rtb_mot_map_a <= rtb_Abs1_f) || rtIsNaNF(rtb_Abs1_f)) {
      rtb_Abs1_f = rtb_mot_map_a;
    }
    ...
    /* '<S869>:1:159' */
    if ((rtb_Gain_p <= rtb_brake_dem) || rtIsNaNF(rtb_brake_dem)) {
      rtb_brake_dem = rtb_Gain_p;
    }

    /* '<S869>:1:159' */
    if (!(0.0F < rtb_brake_dem)) {
      rtb_brake_dem = 0.0F;
    }

    /* '<S869>:1:160' */
    if ((rtb_Saturation3_m <= rtb_mot_map1_j) || rtIsNaNF(rtb_mot_map1_j)) {
      rtb_mot_map1_j = rtb_Saturation3_m;
    }

    /* '<S869>:1:160' */
    if (!(0.0F < rtb_mot_map1_j)) {
      rtb_mot_map1_j = 0.0F;
    }

    /* '<S869>:1:161' */
    if ((rtb_Add2_c <= rtb_DLookupTable_g) || rtIsNaNF(rtb_DLookupTable_g)) {
      rtb_DLookupTable_g = rtb_Add2_c;
    }

    /* '<S869>:1:161' */
    if (!(0.0F < rtb_DLookupTable_g)) {
      rtb_DLookupTable_g = 0.0F;
    }
    ...
    /* End of MATLAB Function: '<S747>/MATLAB Function' */
    ...
    /* MATLAB Function: '<S734>/HeartBeat' */
    six_plus_six_Acms_HeartBeat(rtb_Memory_l,
      &six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat_i);

    /* Switch: '<S734>/Switch4' incorporates:
     *  Constant: '<S734>/mot_gear4'
     *  Constant: '<S734>/mot_gear5'
     */
    if (six_plus_six_AcmsteeringV09_m_B.steer_dem > 0.0F) {
      rtb_Abs = 2.0F;
    } else {
    ...
    /* Saturate: '<S734>/Saturation1' */
    if (rtb_brake_dem > 70.5F) {
      rtb_Abs10_n = 70.5F;
    } else {
      rtb_Abs10_n = rtb_brake_dem;
    }

    /* End of Saturate: '<S734>/Saturation1' */

    /* Memory: '<S734>/Memory1' */
    rtb_Memory1_f = six_plus_six_AcmsteeringV09__DW.Memory1_PreviousInput_n;

    /* MATLAB Function: '<S734>/HeartBeat1' */
    six_plus_six_Acms_HeartBeat(rtb_Memory1_f,
      &six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat1_jt);

    /* Switch: '<S734>/Switch2' incorporates:
     *  Constant: '<S734>/mot_gear2'
     *  Constant: '<S734>/mot_gear3'
     */
    if (six_plus_six_AcmsteeringV09_m_B.steer_dem > 0.0F) {
      rtb_Gain_p = 2.0F;
    } else {
    ...
    /* End of Switch: '<S734>/Switch2' */

    /* Saturate: '<S734>/Saturation2' */
    if (rtb_mot_map1_j > 70.5F) {
      rtb_brake_dem = 70.5F;
    } else {
      rtb_brake_dem = rtb_mot_map1_j;
    }

    /* End of Saturate: '<S734>/Saturation2' */

    /* Memory: '<S734>/Memory3' */
    rtb_Memory3_a = six_plus_six_AcmsteeringV09__DW.Memory3_PreviousInput_g;

    /* MATLAB Function: '<S734>/HeartBeat2' */
     ...
     *  Constant: '<S734>/mot_gear6'
     *  Constant: '<S734>/mot_gear7'
     */
    if (six_plus_six_AcmsteeringV09_m_B.steer_dem > 0.0F) {
      rtb_mot_map1_j = 2.0F;
    } else {
    ...
    /* Saturate: '<S734>/Saturation9' */
    if (rtb_DLookupTable_g > 70.5F) {
      rtb_Gain5_d = 70.5F;
    } else {
      rtb_Gain5_d = rtb_DLookupTable_g;
    }

    /* End of Saturate: '<S734>/Saturation9' */

    /* Memory: '<S734>/Memory6' */
    rtb_Memory6_e = six_plus_six_AcmsteeringV09__DW.Memory6_PreviousInput_p;

    /* MATLAB Function: '<S734>/HeartBeat4' */
    six_plus_six_Acms_HeartBeat(rtb_Memory6_e,
      &six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat4_c);

    /* Switch: '<S734>/Switch3' incorporates:
     *  Constant: '<S734>/mot_gear10'
     *  Constant: '<S734>/mot_gear11'
     */
    if (six_plus_six_AcmsteeringV09_m_B.steer_dem > 0.0F) {
      rtb_Saturation3_m = 2.0F;
    } else {
    ...
    /* End of Switch: '<S734>/Switch3' */

    /* Saturate: '<S734>/Saturation3' */
    ...
    /* End of Saturate: '<S734>/Saturation3' */

    /* Memory: '<S734>/Memory2' */
    rtb_Memory2_i = six_plus_six_AcmsteeringV09__DW.Memory2_PreviousInput_a;

    /* MATLAB Function: '<S734>/HeartBeat5' */
    six_plus_six_Acms_HeartBeat(rtb_Memory2_i,
      &six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat5_lf);

    /* Lookup_n-D: '<S734>/1-D Lookup Table2' */
    rtb_Abs6_i = look1_iflf_binlx(brake_dem,
      six_plus_six_Acmsteering_ConstP.pooled46,
      six_plus_six_Acmsteering_ConstP.pooled45, 1U);

    /* Saturate: '<S734>/Saturation13' */
    if (rtb_Abs6_i > 750000.0F) {
      rtb_Abs6_i = 750000.0F;
    } else {
      if (rtb_Abs6_i < -140000.0F) {
        rtb_Abs6_i = -140000.0F;
      }
    }

    /* End of Saturate: '<S734>/Saturation13' */

    /* SignalConversion: '<S411>/OutportBufferForcenter_steer_dem' incorporates:
     *  Constant: '<S734>/SpdSet_dem'
     *  Constant: '<S734>/SpdSet_dem1'
     *  Constant: '<S734>/SpdSet_dem2'
     *  Constant: '<S734>/SpdSet_dem3'
     *  Constant: '<S734>/SpdSet_dem4'
     *  Constant: '<S734>/SpdSet_dem5'
     *  Constant: '<S734>/mot_enable1'
     *  Constant: '<S734>/mot_enable2'
     *  Constant: '<S734>/mot_enable3'
     *  Constant: '<S734>/mot_enable4'
     *  Constant: '<S734>/mot_enable5'
     *  Constant: '<S734>/mot_enable6'
     *  Constant: '<S734>/mot_mode'
     *  Constant: '<S734>/mot_mode1'
     *  Constant: '<S734>/mot_mode2'
     *  Constant: '<S734>/mot_mode3'
     *  Constant: '<S734>/mot_mode4'
     *  Constant: '<S734>/mot_mode5'
     */
    ...
    six_plus_six_AcmsteeringV09_m_B.OutportBufferForcenter_steer_de[8] = rtb_Abs;
    ...
    /* Update for Memory: '<S734>/Memory' */
    six_plus_six_AcmsteeringV09__DW.Memory_PreviousInput_m =
      six_plus_six_AcmsteeringV09_m_B.sf_HeartBeat_i.life;

    /* Update for Memory: '<S734>/Memory4' */
    ...
    /* Update for Memory: '<S734>/Memory3' */
    ...
    /* End of Outputs for SubSystem: '<S407>/center_steer' */
    break;

   case 5:
    /* Outputs for IfAction SubSystem: '<S407>/emergency_stop' incorporates:
     *  ActionPort: '<S412>/Action Port'
     */
    /* Memory: '<S870>/Memory' */
    rtb_Memory = six_plus_six_AcmsteeringV09__DW.Memory_PreviousInput_b;

    /* MATLAB Function: '<S870>/HeartBeat' */
    ...
    /* MATLAB Function: '<S870>/HeartBeat3' */
    ...
    /* MATLAB Function: '<S870>/HeartBeat1' */
    ...
    /* MATLAB Function: '<S870>/HeartBeat2' */
    ...
    /* MATLAB Function: '<S870>/HeartBeat4' */
    ...
    /* End of Saturate: '<S870>/Saturation2' */

    /* Gain: '<S870>/Gain1' */
    rtb_Abs1_f = -rtb_Abs1_f;

    /* Saturate: '<S870>/Saturation3' */
    if (rtb_Abs1_f > 400000.0F) {
      rtb_Abs1_f = 400000.0F;
    } else {
      if (rtb_Abs1_f < -400000.0F) {
    ...
    /* End of Saturate: '<S870>/Saturation3' */

    /* Lookup_n-D: '<S870>/1-D Lookup Table1' incorporates:
     *  Constant: '<S870>/Constant'
     */
    rtb_Add2_c = look1_iflf_binlx(100.0F,
      six_plus_six_Acmsteering_ConstP.pooled46,
      six_plus_six_Acmsteering_ConstP.pooled45, 1U);

    /* Saturate: '<S870>/Saturation5' */
    if (rtb_Add2_c > 750000.0F) {
      rtb_Add2_c = 750000.0F;
    } else {
      if (rtb_Add2_c < -140000.0F) {
    ...
    /* End of Saturate: '<S870>/Saturation5' */

    /* SignalConversion: '<S412>/OutportBufferForemergency_stop_dem' incorporates:
     *  Constant: '<S870>/SpdSet_dem'
     *  Constant: '<S870>/SpdSet_dem1'
     *  Constant: '<S870>/SpdSet_dem2'
     *  Constant: '<S870>/SpdSet_dem3'
     *  Constant: '<S870>/SpdSet_dem4'
     *  Constant: '<S870>/SpdSet_dem5'
     *  Constant: '<S870>/TrqSet_dem'
     *  Constant: '<S870>/TrqSet_dem1'
     *  Constant: '<S870>/TrqSet_dem2'
     *  Constant: '<S870>/TrqSet_dem3'
     *  Constant: '<S870>/TrqSet_dem4'
     *  Constant: '<S870>/TrqSet_dem5'
     *  Constant: '<S870>/mot_enable'
     *  Constant: '<S870>/mot_enable1'
     *  Constant: '<S870>/mot_enable2'
     *  Constant: '<S870>/mot_enable3'
     *  Constant: '<S870>/mot_enable4'
     *  Constant: '<S870>/mot_enable5'
     *  Constant: '<S870>/mot_gear'
     *  Constant: '<S870>/mot_gear1'
     *  Constant: '<S870>/mot_gear2'
     *  Constant: '<S870>/mot_gear3'
     *  Constant: '<S870>/mot_gear4'
     *  Constant: '<S870>/mot_gear5'
     *  Constant: '<S870>/mot_mode'
     *  Constant: '<S870>/mot_mode1'
     *  Constant: '<S870>/mot_mode2'
     *  Constant: '<S870>/mot_mode3'
     *  Constant: '<S870>/mot_mode4'
     *  Constant: '<S870>/mot_mode5'
     */
  ...
  /* End of MultiPortSwitch: '<S407>/Multiport Switch' */
   ...
   */
  /* Saturate: '<S1254>/VCU1_GearCmd_sat' */
  ...
  /* End of Saturate: '<S1254>/VCU1_GearCmd_sat' */

  /* Rounding: '<S1254>/VCU1_GearCmdRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1254>/VCU1_GearCmd_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 3);

  /* DataTypeConversion: '<S1254>/VCU1_GearCmd_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1254>/VCU1_GearCmd_L' */
  rtb_VCU1_LifeCnt_L &= 24U;

  /* DataTypeConversion: '<S1254>/VCU1_GearCmd_Convert' */
  rtb_VCU1_EnableReq_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1252>/VCU1_CtrlModel_sat' */
  ...
  /* End of Saturate: '<S1252>/VCU1_CtrlModel_sat' */

  /* Rounding: '<S1252>/VCU1_CtrlModelRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1252>/VCU1_CtrlModel_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 2);

  /* DataTypeConversion: '<S1252>/VCU1_CtrlModel_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1252>/VCU1_CtrlModel_L' */
  rtb_VCU1_LifeCnt_L &= 4U;

  /* DataTypeConversion: '<S1252>/VCU1_CtrlModel_Convert' */
  rtb_VCU1_CtrlModel_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1253>/VCU1_EnableReq_sat' */
  ...
  /* End of Saturate: '<S1253>/VCU1_EnableReq_sat' */

  /* Rounding: '<S1253>/VCU1_EnableReqRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1253>/VCU1_EnableReq_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1253>/VCU1_EnableReq_L' */
  rtb_VCU1_LifeCnt_L &= 3U;

  /* DataTypeConversion: '<S1253>/VCU1_EnableReq_Convert' */
  ...
  /* Saturate: '<S1256>/VCU1_SpeedMax_sat' */
  ...
  /* End of Saturate: '<S1256>/VCU1_SpeedMax_sat' */

  /* Rounding: '<S1256>/VCU1_SpeedMaxRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1256>/VCU1_SpeedMax_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1256>/VCU1_SpeedMax_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1256>/VCU1_SpeedMax_D1' incorporates:
   *  Constant: '<S1256>/VCU1_SpeedMaxoutput2_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1256>/VCU1_SpeedMaxCOV' */
  ...
  /* S-Function (sfix_bitop): '<S1256>/VCU1_SpeedMax_And' incorporates:
   *  Constant: '<S1256>/VCU1_SpeedMax_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1256>/VCU1_SpeedMaxBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1226>/or3' */
  six_plus_six_AcmsteeringV09_m_B.or3 = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1257>/VCU1_TorqueRef_sat' */
  ...
  /* End of Saturate: '<S1257>/VCU1_TorqueRef_sat' */

  /* Sum: '<S1257>/VCU1_TorqueRef_st' incorporates:
   *  Constant: '<S1257>/VCU1_TorqueRef_O'
   */
  rtb_acc_dem -= -1000.0F;

  /* Product: '<S1257>/VCU1_TorqueRef_D' incorporates:
   *  Constant: '<S1257>/VCU1_TorqueRef_F'
   */
  rtb_acc_dem /= 0.1F;

  /* Rounding: '<S1257>/VCU1_TorqueRefRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1257>/VCU1_TorqueRef_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1257>/VCU1_TorqueRef_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1257>/VCU1_TorqueRef_D1' incorporates:
   *  Constant: '<S1257>/VCU1_TorqueRefoutput4_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1257>/VCU1_TorqueRefCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1226>/or4' */
  six_plus_six_AcmsteeringV09_m_B.or4 = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1257>/VCU1_TorqueRef_And' incorporates:
   *  Constant: '<S1257>/VCU1_TorqueRef_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1257>/VCU1_TorqueRefBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1226>/or5' */
  six_plus_six_AcmsteeringV09_m_B.or5 = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1255>/VCU1_LifeCnt_sat' */
  ...
  /* End of Saturate: '<S1255>/VCU1_LifeCnt_sat' */

  /* Rounding: '<S1255>/VCU1_LifeCntRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1255>/VCU1_LifeCnt_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1255>/VCU1_LifeCnt_L' */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1255>/VCU1_LifeCnt_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* Saturate: '<S1236>/VCU1_GearCmd_sat' */
  ...
  /* End of Saturate: '<S1236>/VCU1_GearCmd_sat' */

  /* Rounding: '<S1236>/VCU1_GearCmdRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1236>/VCU1_GearCmd_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 3);

  /* DataTypeConversion: '<S1236>/VCU1_GearCmd_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1236>/VCU1_GearCmd_L' */
  rtb_VCU1_LifeCnt_L &= 24U;

  /* DataTypeConversion: '<S1236>/VCU1_GearCmd_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1234>/VCU1_CtrlModel_sat' */
  ...
  /* End of Saturate: '<S1234>/VCU1_CtrlModel_sat' */

  /* Rounding: '<S1234>/VCU1_CtrlModelRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1234>/VCU1_CtrlModel_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 2);

  /* DataTypeConversion: '<S1234>/VCU1_CtrlModel_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1234>/VCU1_CtrlModel_L' */
  rtb_VCU1_LifeCnt_L &= 4U;

  /* DataTypeConversion: '<S1234>/VCU1_CtrlModel_Convert' */
  rtb_VCU1_CtrlModel_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1235>/VCU1_EnableReq_sat' */
  ...
  /* End of Saturate: '<S1235>/VCU1_EnableReq_sat' */

  /* Rounding: '<S1235>/VCU1_EnableReqRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1235>/VCU1_EnableReq_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1235>/VCU1_EnableReq_L' */
  rtb_VCU1_LifeCnt_L &= 3U;

  /* DataTypeConversion: '<S1235>/VCU1_EnableReq_Convert' */
  rtb_VCU1_EnableReq_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* Saturate: '<S1238>/VCU1_SpeedMax_sat' */
  ...
  /* End of Saturate: '<S1238>/VCU1_SpeedMax_sat' */

  /* Rounding: '<S1238>/VCU1_SpeedMaxRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1238>/VCU1_SpeedMax_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1238>/VCU1_SpeedMax_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1238>/VCU1_SpeedMax_D1' incorporates:
   *  Constant: '<S1238>/VCU1_SpeedMaxoutput2_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1238>/VCU1_SpeedMaxCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1223>/or2' */
  six_plus_six_AcmsteeringV09_m_B.or2_m = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1238>/VCU1_SpeedMax_And' incorporates:
   *  Constant: '<S1238>/VCU1_SpeedMax_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1238>/VCU1_SpeedMaxBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1223>/or3' */
  six_plus_six_AcmsteeringV09_m_B.or3_l = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1239>/VCU1_TorqueRef_sat' */
  ...
  /* End of Saturate: '<S1239>/VCU1_TorqueRef_sat' */

  /* Sum: '<S1239>/VCU1_TorqueRef_st' incorporates:
   *  Constant: '<S1239>/VCU1_TorqueRef_O'
   */
  rtb_acc_dem -= -1000.0F;

  /* Product: '<S1239>/VCU1_TorqueRef_D' incorporates:
   *  Constant: '<S1239>/VCU1_TorqueRef_F'
   */
  rtb_acc_dem /= 0.1F;

  /* Rounding: '<S1239>/VCU1_TorqueRefRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1239>/VCU1_TorqueRef_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1239>/VCU1_TorqueRef_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1239>/VCU1_TorqueRef_D1' incorporates:
   *  Constant: '<S1239>/VCU1_TorqueRefoutput4_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1239>/VCU1_TorqueRefCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1223>/or4' */
  six_plus_six_AcmsteeringV09_m_B.or4_m = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1239>/VCU1_TorqueRef_And' incorporates:
   *  Constant: '<S1239>/VCU1_TorqueRef_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1239>/VCU1_TorqueRefBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1223>/or5' */
  six_plus_six_AcmsteeringV09_m_B.or5_d = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1237>/VCU1_LifeCnt_sat' */
  ...
  /* End of Saturate: '<S1237>/VCU1_LifeCnt_sat' */

  /* Rounding: '<S1237>/VCU1_LifeCntRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1237>/VCU1_LifeCnt_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1237>/VCU1_LifeCnt_L' */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1237>/VCU1_LifeCnt_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* Saturate: '<S1248>/VCU1_GearCmd_sat' */
  ...
  /* End of Saturate: '<S1248>/VCU1_GearCmd_sat' */

  /* Rounding: '<S1248>/VCU1_GearCmdRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1248>/VCU1_GearCmd_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 3);

  /* DataTypeConversion: '<S1248>/VCU1_GearCmd_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1248>/VCU1_GearCmd_L' */
  rtb_VCU1_LifeCnt_L &= 24U;

  /* DataTypeConversion: '<S1248>/VCU1_GearCmd_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1246>/VCU1_CtrlModel_sat' */
  ...
  /* End of Saturate: '<S1246>/VCU1_CtrlModel_sat' */

  /* Rounding: '<S1246>/VCU1_CtrlModelRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1246>/VCU1_CtrlModel_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 2);

  /* DataTypeConversion: '<S1246>/VCU1_CtrlModel_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1246>/VCU1_CtrlModel_L' */
  rtb_VCU1_LifeCnt_L &= 4U;

  /* DataTypeConversion: '<S1246>/VCU1_CtrlModel_Convert' */
  rtb_VCU1_CtrlModel_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1247>/VCU1_EnableReq_sat' */
  ...
  /* End of Saturate: '<S1247>/VCU1_EnableReq_sat' */

  /* Rounding: '<S1247>/VCU1_EnableReqRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1247>/VCU1_EnableReq_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1247>/VCU1_EnableReq_L' */
  rtb_VCU1_LifeCnt_L &= 3U;

  /* DataTypeConversion: '<S1247>/VCU1_EnableReq_Convert' */
  rtb_VCU1_EnableReq_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* Saturate: '<S1250>/VCU1_SpeedMax_sat' */
  ...
  /* End of Saturate: '<S1250>/VCU1_SpeedMax_sat' */

  /* Rounding: '<S1250>/VCU1_SpeedMaxRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1250>/VCU1_SpeedMax_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1250>/VCU1_SpeedMax_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1250>/VCU1_SpeedMax_D1' incorporates:
   *  Constant: '<S1250>/VCU1_SpeedMaxoutput2_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1250>/VCU1_SpeedMaxCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1225>/or2' */
  six_plus_six_AcmsteeringV09_m_B.or2_d = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1250>/VCU1_SpeedMax_And' incorporates:
   *  Constant: '<S1250>/VCU1_SpeedMax_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1250>/VCU1_SpeedMaxBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1225>/or3' */
  six_plus_six_AcmsteeringV09_m_B.or3_k = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1251>/VCU1_TorqueRef_sat' */
  ...
  /* End of Saturate: '<S1251>/VCU1_TorqueRef_sat' */

  /* Sum: '<S1251>/VCU1_TorqueRef_st' incorporates:
   *  Constant: '<S1251>/VCU1_TorqueRef_O'
   */
  rtb_acc_dem -= -1000.0F;

  /* Product: '<S1251>/VCU1_TorqueRef_D' incorporates:
   *  Constant: '<S1251>/VCU1_TorqueRef_F'
   */
  rtb_acc_dem /= 0.1F;

  /* Rounding: '<S1251>/VCU1_TorqueRefRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1251>/VCU1_TorqueRef_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1251>/VCU1_TorqueRef_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1251>/VCU1_TorqueRef_D1' incorporates:
   *  Constant: '<S1251>/VCU1_TorqueRefoutput4_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1251>/VCU1_TorqueRefCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1225>/or4' */
  six_plus_six_AcmsteeringV09_m_B.or4_d = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1251>/VCU1_TorqueRef_And' incorporates:
   *  Constant: '<S1251>/VCU1_TorqueRef_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1251>/VCU1_TorqueRefBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1225>/or5' */
  six_plus_six_AcmsteeringV09_m_B.or5_i = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1249>/VCU1_LifeCnt_sat' */
  ...
  /* End of Saturate: '<S1249>/VCU1_LifeCnt_sat' */

  /* Rounding: '<S1249>/VCU1_LifeCntRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1249>/VCU1_LifeCnt_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1249>/VCU1_LifeCnt_L' */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1249>/VCU1_LifeCnt_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* Saturate: '<S1230>/VCU1_GearCmd_sat' */
  ...
  /* End of Saturate: '<S1230>/VCU1_GearCmd_sat' */

  /* Rounding: '<S1230>/VCU1_GearCmdRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1230>/VCU1_GearCmd_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 3);

  /* DataTypeConversion: '<S1230>/VCU1_GearCmd_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1230>/VCU1_GearCmd_L' */
  rtb_VCU1_LifeCnt_L &= 24U;

  /* DataTypeConversion: '<S1230>/VCU1_GearCmd_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1228>/VCU1_CtrlModel_sat' */
  ...
  /* End of Saturate: '<S1228>/VCU1_CtrlModel_sat' */

  /* Rounding: '<S1228>/VCU1_CtrlModelRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1228>/VCU1_CtrlModel_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 2);

  /* DataTypeConversion: '<S1228>/VCU1_CtrlModel_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1228>/VCU1_CtrlModel_L' */
  rtb_VCU1_LifeCnt_L &= 4U;

  /* DataTypeConversion: '<S1228>/VCU1_CtrlModel_Convert' */
  rtb_VCU1_CtrlModel_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1229>/VCU1_EnableReq_sat' */
  ...
  /* End of Saturate: '<S1229>/VCU1_EnableReq_sat' */

  /* Rounding: '<S1229>/VCU1_EnableReqRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1229>/VCU1_EnableReq_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1229>/VCU1_EnableReq_L' */
  rtb_VCU1_LifeCnt_L &= 3U;

  /* DataTypeConversion: '<S1229>/VCU1_EnableReq_Convert' */
  rtb_VCU1_EnableReq_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1222>/or1' */
  six_plus_six_AcmsteeringV09_m_B.or1_k = (uint8_T)(rtb_VCU1_LifeCnt_Convert |
    rtb_VCU1_CtrlModel_Convert | rtb_VCU1_EnableReq_Convert);

  /* Saturate: '<S1232>/VCU1_SpeedMax_sat' */
  ...
  /* End of Saturate: '<S1232>/VCU1_SpeedMax_sat' */

  /* Rounding: '<S1232>/VCU1_SpeedMaxRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1232>/VCU1_SpeedMax_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1232>/VCU1_SpeedMax_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1232>/VCU1_SpeedMax_D1' incorporates:
   *  Constant: '<S1232>/VCU1_SpeedMaxoutput2_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1232>/VCU1_SpeedMaxCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1222>/or2' */
  six_plus_six_AcmsteeringV09_m_B.or2_de = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1232>/VCU1_SpeedMax_And' incorporates:
   *  Constant: '<S1232>/VCU1_SpeedMax_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1232>/VCU1_SpeedMaxBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1222>/or3' */
  six_plus_six_AcmsteeringV09_m_B.or3_p = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1233>/VCU1_TorqueRef_sat' */
  ...
  /* End of Saturate: '<S1233>/VCU1_TorqueRef_sat' */

  /* Sum: '<S1233>/VCU1_TorqueRef_st' incorporates:
   *  Constant: '<S1233>/VCU1_TorqueRef_O'
   */
  rtb_acc_dem -= -1000.0F;

  /* Product: '<S1233>/VCU1_TorqueRef_D' incorporates:
   *  Constant: '<S1233>/VCU1_TorqueRef_F'
   */
  rtb_acc_dem /= 0.1F;

  /* Rounding: '<S1233>/VCU1_TorqueRefRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1233>/VCU1_TorqueRef_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1233>/VCU1_TorqueRef_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1233>/VCU1_TorqueRef_D1' incorporates:
   *  Constant: '<S1233>/VCU1_TorqueRefoutput4_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1233>/VCU1_TorqueRefCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1222>/or4' */
  six_plus_six_AcmsteeringV09_m_B.or4_e = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1233>/VCU1_TorqueRef_And' incorporates:
   *  Constant: '<S1233>/VCU1_TorqueRef_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1233>/VCU1_TorqueRefBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1222>/or5' */
  six_plus_six_AcmsteeringV09_m_B.or5_e = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1231>/VCU1_LifeCnt_sat' */
  ...
  /* End of Saturate: '<S1231>/VCU1_LifeCnt_sat' */

  /* Rounding: '<S1231>/VCU1_LifeCntRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1231>/VCU1_LifeCnt_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1231>/VCU1_LifeCnt_L' */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1231>/VCU1_LifeCnt_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1222>/or8' */
  ...
  /* Saturate: '<S1242>/VCU1_GearCmd_sat' */
  ...
  /* End of Saturate: '<S1242>/VCU1_GearCmd_sat' */

  /* Rounding: '<S1242>/VCU1_GearCmdRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1242>/VCU1_GearCmd_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 3);

  /* DataTypeConversion: '<S1242>/VCU1_GearCmd_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1242>/VCU1_GearCmd_L' */
  rtb_VCU1_LifeCnt_L &= 24U;

  /* DataTypeConversion: '<S1242>/VCU1_GearCmd_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1240>/VCU1_CtrlModel_sat' */
  ...
  /* End of Saturate: '<S1240>/VCU1_CtrlModel_sat' */

  /* Rounding: '<S1240>/VCU1_CtrlModelRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1240>/VCU1_CtrlModel_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 2);

  /* DataTypeConversion: '<S1240>/VCU1_CtrlModel_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1240>/VCU1_CtrlModel_L' */
  rtb_VCU1_LifeCnt_L &= 4U;

  /* DataTypeConversion: '<S1240>/VCU1_CtrlModel_Convert' */
  rtb_VCU1_CtrlModel_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1241>/VCU1_EnableReq_sat' */
  ...
  /* End of Saturate: '<S1241>/VCU1_EnableReq_sat' */

  /* Rounding: '<S1241>/VCU1_EnableReqRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1241>/VCU1_EnableReq_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1241>/VCU1_EnableReq_L' */
  rtb_VCU1_LifeCnt_L &= 3U;

  /* DataTypeConversion: '<S1241>/VCU1_EnableReq_Convert' */
  rtb_VCU1_EnableReq_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* Saturate: '<S1244>/VCU1_SpeedMax_sat' */
  ...
  /* End of Saturate: '<S1244>/VCU1_SpeedMax_sat' */

  /* Rounding: '<S1244>/VCU1_SpeedMaxRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1244>/VCU1_SpeedMax_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1244>/VCU1_SpeedMax_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1244>/VCU1_SpeedMax_D1' incorporates:
   *  Constant: '<S1244>/VCU1_SpeedMaxoutput2_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1244>/VCU1_SpeedMaxCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1224>/or2' */
  six_plus_six_AcmsteeringV09_m_B.or2_b = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1244>/VCU1_SpeedMax_And' incorporates:
   *  Constant: '<S1244>/VCU1_SpeedMax_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1244>/VCU1_SpeedMaxBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1224>/or3' */
  six_plus_six_AcmsteeringV09_m_B.or3_b = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1245>/VCU1_TorqueRef_sat' */
  ...
  /* End of Saturate: '<S1245>/VCU1_TorqueRef_sat' */

  /* Sum: '<S1245>/VCU1_TorqueRef_st' incorporates:
   *  Constant: '<S1245>/VCU1_TorqueRef_O'
   */
  rtb_acc_dem -= -1000.0F;

  /* Product: '<S1245>/VCU1_TorqueRef_D' incorporates:
   *  Constant: '<S1245>/VCU1_TorqueRef_F'
   */
  rtb_acc_dem /= 0.1F;

  /* Rounding: '<S1245>/VCU1_TorqueRefRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1245>/VCU1_TorqueRef_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1245>/VCU1_TorqueRef_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1245>/VCU1_TorqueRef_D1' incorporates:
   *  Constant: '<S1245>/VCU1_TorqueRefoutput4_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1245>/VCU1_TorqueRefCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1224>/or4' */
  six_plus_six_AcmsteeringV09_m_B.or4_mz = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1245>/VCU1_TorqueRef_And' incorporates:
   *  Constant: '<S1245>/VCU1_TorqueRef_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1245>/VCU1_TorqueRefBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1224>/or5' */
  six_plus_six_AcmsteeringV09_m_B.or5_j = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1243>/VCU1_LifeCnt_sat' */
  ...
  /* End of Saturate: '<S1243>/VCU1_LifeCnt_sat' */

  /* Rounding: '<S1243>/VCU1_LifeCntRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1243>/VCU1_LifeCnt_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1243>/VCU1_LifeCnt_L' */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1243>/VCU1_LifeCnt_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* Saturate: '<S1260>/VCU1_GearCmd_sat' */
  ...
  /* End of Saturate: '<S1260>/VCU1_GearCmd_sat' */

  /* Rounding: '<S1260>/VCU1_GearCmdRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1260>/VCU1_GearCmd_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 3);

  /* DataTypeConversion: '<S1260>/VCU1_GearCmd_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1260>/VCU1_GearCmd_L' */
  rtb_VCU1_LifeCnt_L &= 24U;

  /* DataTypeConversion: '<S1260>/VCU1_GearCmd_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1258>/VCU1_CtrlModel_sat' */
  ...
  /* End of Saturate: '<S1258>/VCU1_CtrlModel_sat' */

  /* Rounding: '<S1258>/VCU1_CtrlModelRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* ArithShift: '<S1258>/VCU1_CtrlModel_S' */
  rtb_acc_dem = (real32_T)ldexp(rtb_acc_dem, 2);

  /* DataTypeConversion: '<S1258>/VCU1_CtrlModel_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1258>/VCU1_CtrlModel_L' */
  rtb_VCU1_LifeCnt_L &= 4U;

  /* DataTypeConversion: '<S1258>/VCU1_CtrlModel_Convert' */
  rtb_VCU1_CtrlModel_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* Saturate: '<S1259>/VCU1_EnableReq_sat' */
  ...
  /* End of Saturate: '<S1259>/VCU1_EnableReq_sat' */

  /* Rounding: '<S1259>/VCU1_EnableReqRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1259>/VCU1_EnableReq_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1259>/VCU1_EnableReq_L' */
  rtb_VCU1_LifeCnt_L &= 3U;

  /* DataTypeConversion: '<S1259>/VCU1_EnableReq_Convert' */
  rtb_VCU1_EnableReq_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* Saturate: '<S1262>/VCU1_SpeedMax_sat' */
  ...
  /* End of Saturate: '<S1262>/VCU1_SpeedMax_sat' */

  /* Rounding: '<S1262>/VCU1_SpeedMaxRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1262>/VCU1_SpeedMax_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1262>/VCU1_SpeedMax_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1262>/VCU1_SpeedMax_D1' incorporates:
   *  Constant: '<S1262>/VCU1_SpeedMaxoutput2_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1262>/VCU1_SpeedMaxCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1227>/or2' */
  six_plus_six_AcmsteeringV09_m_B.or2_i = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1262>/VCU1_SpeedMax_And' incorporates:
   *  Constant: '<S1262>/VCU1_SpeedMax_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1262>/VCU1_SpeedMaxBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1227>/or3' */
  six_plus_six_AcmsteeringV09_m_B.or3_d = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1263>/VCU1_TorqueRef_sat' */
  ...
  /* End of Saturate: '<S1263>/VCU1_TorqueRef_sat' */

  /* Sum: '<S1263>/VCU1_TorqueRef_st' incorporates:
   *  Constant: '<S1263>/VCU1_TorqueRef_O'
   */
  rtb_acc_dem -= -1000.0F;

  /* Product: '<S1263>/VCU1_TorqueRef_D' incorporates:
   *  Constant: '<S1263>/VCU1_TorqueRef_F'
   */
  rtb_acc_dem /= 0.1F;

  /* Rounding: '<S1263>/VCU1_TorqueRefRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1263>/VCU1_TorqueRef_Convert' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1263>/VCU1_TorqueRef_L' */
  rtb_VCU1_LifeCnt_L &= 65535U;

  /* Product: '<S1263>/VCU1_TorqueRef_D1' incorporates:
   *  Constant: '<S1263>/VCU1_TorqueRefoutput4_C'
   */
  rtb_y = (real_T)rtb_VCU1_LifeCnt_L / 256.0;

  /* DataTypeConversion: '<S1263>/VCU1_TorqueRefCOV' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_y;

  /* S-Function (sfix_bitop): '<S1227>/or4' */
  six_plus_six_AcmsteeringV09_m_B.or4_j = rtb_VCU1_LifeCnt_Convert;

  /* S-Function (sfix_bitop): '<S1263>/VCU1_TorqueRef_And' incorporates:
   *  Constant: '<S1263>/VCU1_TorqueRef_And_C'
   */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1263>/VCU1_TorqueRefBitCov' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;

  /* S-Function (sfix_bitop): '<S1227>/or5' */
  six_plus_six_AcmsteeringV09_m_B.or5_jy = rtb_VCU1_LifeCnt_Convert;

  /* Saturate: '<S1261>/VCU1_LifeCnt_sat' */
  ...
  /* End of Saturate: '<S1261>/VCU1_LifeCnt_sat' */

  /* Rounding: '<S1261>/VCU1_LifeCntRon' */
  rtb_acc_dem = rt_roundf_snf(rtb_acc_dem);

  /* DataTypeConversion: '<S1261>/VCU1_LifeCnt_Convert1' */
  rtb_VCU1_LifeCnt_L = (uint32_T)rtb_acc_dem;

  /* S-Function (sfix_bitop): '<S1261>/VCU1_LifeCnt_L' */
  rtb_VCU1_LifeCnt_L &= 255U;

  /* DataTypeConversion: '<S1261>/VCU1_LifeCnt_Convert' */
  rtb_VCU1_LifeCnt_Convert = (uint8_T)rtb_VCU1_LifeCnt_L;
  ...
  /* S-Function (fcncallgen): '<S1198>/50ms' incorporates:
   *  SubSystem: '<S1198>/daq50ms'
   */
...
void six_plus_six_AcmsteeringV09_main_step5(void) /* Sample time: [0.1s, 0.0s] */
{
  /* S-Function (fcncallgen): '<S1197>/100MS' incorporates:
   *  SubSystem: '<S1197>/Function-Call Subsystem'
   */

  /* S-Function (ec5744_canreceiveslb): '<S1201>/CANReceive' */
  ...
  /* Call the system: <S1201>/Function-Call Subsystem */

  /* Output and update for function-call system: '<S1201>/Function-Call Subsystem' */
  {
    uint8_T rtb_Add;
    uint8_T rtb_Compare;

    /* Outputs for Enabled SubSystem: '<S1202>/Enabled Subsystem' incorporates:
     *  EnablePort: '<S1203>/Enable'
     */
    if (six_plus_six_AcmsteeringV09_m_B.CANReceive_o2_c > 0) {
      /* RelationalOperator: '<S1204>/Compare' incorporates:
      ...
      /* If: '<S1203>/If' incorporates:
       *  Constant: '<S1208>/Constant'
       */
      if (rtb_Compare > 0) {
        /* Outputs for IfAction SubSystem: '<S1203>/If Action Subsystem' incorporates:
         *  ActionPort: '<S1207>/Action Port'
         */

        /* S-Function (ec5744_bootloaderslb): '<S1207>/BootLoader' */
        {
          uint16 i= 0;
        ...
        /* S-Function (ec5744_cpuresetslb): '<S1207>/CPUReset' */

        /* Perform a microcontroller reset */
        MC_ME.MCTL.R = 0X00005AF0;
        MC_ME.MCTL.R = 0X0000A50F;

        /* End of Outputs for SubSystem: '<S1203>/If Action Subsystem' */
      } else {
        /* Outputs for IfAction SubSystem: '<S1203>/If Action Subsystem1' incorporates:
         *  ActionPort: '<S1208>/Action Port'
         */

        /* S-Function (ec5744_cantransmitslb): '<S1208>/CANTransmit' */
        ...
        /* End of Outputs for SubSystem: '<S1203>/If Action Subsystem1' */
      }

      /* End of If: '<S1203>/If' */
    }

    /* End of Outputs for SubSystem: '<S1202>/Enabled Subsystem' */
  }

  /* S-Function (fcncallgen): '<S1198>/100ms' incorporates:
   *  SubSystem: '<S1198>/daq100ms'
   */

  /* S-Function (ec5744_ccpslb1): '<S1209>/CCPDAQ' */
  ccpDaq(3);
}

/* Model step function for TID6 */
void six_plus_six_AcmsteeringV09_main_step6(void) /* Sample time: [0.5s, 0.0s] */
{
  /* S-Function (fcncallgen): '<S1198>/500ms' incorporates:
   *  SubSystem: '<S1198>/daq500ms'
   */
   ...
   *  SubSystem: '<S1199>/EEPROMOperation'
   */

  /* S-Function (ec5744_eepromoslb): '<S1214>/EEPROMOperatin' */
...
void six_plus_six_AcmsteeringV09_main_step(int_T tid)
{
  switch (tid) {
   case 0 :
    six_plus_six_AcmsteeringV09_main_step0();
    break;

   case 1 :
    six_plus_six_AcmsteeringV09_main_step1();
    break;

   case 2 :
    six_plus_six_AcmsteeringV09_main_step2();
    break;

   case 3 :
    six_plus_six_AcmsteeringV09_main_step3();
    break;

   case 4 :
    six_plus_six_AcmsteeringV09_main_step4();
    break;

   case 5 :
    six_plus_six_AcmsteeringV09_main_step5();
    break;

   case 6 :
    six_plus_six_AcmsteeringV09_main_step6();
    break;
...
void six_plus_six_AcmsteeringV09_main_initialize(void)
{
  /* Registration code */
  ...
  /* Start for IfAction SubSystem: '<S407>/forward' */
  /* Start for SwitchCase: '<S877>/Switch Case1' */
  six_plus_six_AcmsteeringV09__DW.SwitchCase1_ActiveSubsystem_g = -1;

  /* Start for IfAction SubSystem: '<S877>/Drive' */
  /* Start for Atomic SubSystem: '<S1030>/直行TCS' */
  /* Start for Atomic SubSystem: '<S1158>/直行' */
  /* Start for If: '<S1182>/If' */
  six_plus_six_AcmsteeringV09__DW.If_ActiveSubsystem_a = -1;

  /* Start for If: '<S1182>/If4' */
  six_plus_six_AcmsteeringV09__DW.If4_ActiveSubsystem_b = -1;

  /* Start for If: '<S1182>/If1' */
  six_plus_six_AcmsteeringV09__DW.If1_ActiveSubsystem_c = -1;

  /* Start for If: '<S1182>/If2' */
  six_plus_six_AcmsteeringV09__DW.If2_ActiveSubsystem_b = -1;

  /* Start for If: '<S1182>/If5' */
  six_plus_six_AcmsteeringV09__DW.If5_ActiveSubsystem_k = -1;

  /* Start for If: '<S1182>/If3' */
  six_plus_six_AcmsteeringV09__DW.If3_ActiveSubsystem_c = -1;

  /* End of Start for SubSystem: '<S1158>/直行' */
  /* End of Start for SubSystem: '<S1030>/直行TCS' */
  /* End of Start for SubSystem: '<S877>/Drive' */
  /* End of Start for SubSystem: '<S407>/forward' */

  /* Start for IfAction SubSystem: '<S407>/backward' */
  /* Start for SwitchCase: '<S422>/Switch Case1' */
  six_plus_six_AcmsteeringV09__DW.SwitchCase1_ActiveSubsystem = -1;

  /* Start for IfAction SubSystem: '<S422>/Drive' */
  /* Start for Atomic SubSystem: '<S575>/直行TCS' */
  /* Start for Atomic SubSystem: '<S703>/直行' */
  /* Start for If: '<S727>/If' */
  six_plus_six_AcmsteeringV09__DW.If_ActiveSubsystem = -1;

  /* Start for If: '<S727>/If4' */
  six_plus_six_AcmsteeringV09__DW.If4_ActiveSubsystem = -1;

  /* Start for If: '<S727>/If1' */
  six_plus_six_AcmsteeringV09__DW.If1_ActiveSubsystem = -1;

  /* Start for If: '<S727>/If2' */
  six_plus_six_AcmsteeringV09__DW.If2_ActiveSubsystem = -1;

  /* Start for If: '<S727>/If5' */
  six_plus_six_AcmsteeringV09__DW.If5_ActiveSubsystem = -1;

  /* Start for If: '<S727>/If3' */
  six_plus_six_AcmsteeringV09__DW.If3_ActiveSubsystem = -1;

  /* End of Start for SubSystem: '<S703>/直行' */
  /* End of Start for SubSystem: '<S575>/直行TCS' */
  /* End of Start for SubSystem: '<S422>/Drive' */
  /* End of Start for SubSystem: '<S407>/backward' */
  ...
  /* Start for S-Function (fcncallgen): '<S1197>/100MS' incorporates:
   *  Start for SubSystem: '<S1197>/Function-Call Subsystem'
   */
  /* Start for S-Function (ec5744_canreceiveslb): '<S1201>/CANReceive' incorporates:
   *  Start for SubSystem: '<S1201>/Function-Call Subsystem'
   */
  /* Start for function-call system: '<S1201>/Function-Call Subsystem' */

  /* Start for Enabled SubSystem: '<S1202>/Enabled Subsystem' */

  /* Start for IfAction SubSystem: '<S1203>/If Action Subsystem1' */

  /* Start for S-Function (ec5744_cantransmitslb): '<S1208>/CANTransmit' */
  ec_buffer_init(2,9,0,593U);

  /* End of Start for SubSystem: '<S1203>/If Action Subsystem1' */

  /* End of Start for SubSystem: '<S1202>/Enabled Subsystem' */

  /* Start for S-Function (ec5744_canreceiveslb): '<S1201>/CANReceive' */
  ec_buffer_init(2,1,0,278);

  /* Start for S-Function (fcncallgen): '<S1200>/Function-Call Generator' incorporates:
   *  Start for SubSystem: '<S1200>/CCPBackground'
   */
  /* Start for S-Function (ec5744_ccpslb): '<S1215>/CCPBackground' */
  ccpInit();

  /* Start for S-Function (ec5744_caninterruptslb1): '<S1200>/ReceiveandTransmitInterrupt' incorporates:
   *  Start for SubSystem: '<S1200>/CCPReceive'
   */
  /* Start for function-call system: '<S1200>/CCPReceive' */

  /* Start for S-Function (ec5744_canreceiveslb): '<S1216>/CANReceive' */
  ec_buffer_init(2,0,0,CCP_CRO_ID);

  /* Start for S-Function (ec5744_caninterruptslb1): '<S1200>/ReceiveandTransmitInterrupt' */
  ec_bufint_init(2,0);
  INTC_0.PSR[548].B.PRIN = 12;
  IntcIsrVectorTable[548] = (uint32_t)&ISR_FlexCAN_2_MB0;
}

/* File trailer for ECUCoder generated file six_plus_six_AcmsteeringV09_main.c.
 *
 * [EOF]
 */

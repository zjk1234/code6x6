...
void rt_OneStep(void)
{
  ...
  six_plus_six_AcmsteeringV09_main_SetEventsForThisBaseStep(ECUCodereventFlags);
  ...
  for (i = 1; i < 7; i++) {
    if (ECUCodereventFlags[i]) {
      ...
      six_plus_six_AcmsteeringV09_main_step(i);
...
main()
{
  ...
  /* Initialize model */
  six_plus_six_AcmsteeringV09_main_initialize();
